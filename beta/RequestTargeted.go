...
// TargetedManagedAppConfigurationPolicySetItemRequestBuilder is request builder for TargetedManagedAppConfigurationPolicySetItem
type TargetedManagedAppConfigurationPolicySetItemRequestBuilder struct{ BaseRequestBuilder }

// Request returns TargetedManagedAppConfigurationPolicySetItemRequest
func (b *TargetedManagedAppConfigurationPolicySetItemRequestBuilder) Request() *TargetedManagedAppConfigurationPolicySetItemRequest {
	return &TargetedManagedAppConfigurationPolicySetItemRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// TargetedManagedAppConfigurationPolicySetItemRequest is request for TargetedManagedAppConfigurationPolicySetItem
type TargetedManagedAppConfigurationPolicySetItemRequest struct{ BaseRequest }

// Get performs GET request for TargetedManagedAppConfigurationPolicySetItem
func (r *TargetedManagedAppConfigurationPolicySetItemRequest) Get(ctx context.Context) (resObj *TargetedManagedAppConfigurationPolicySetItem, err error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Update performs PATCH request for TargetedManagedAppConfigurationPolicySetItem
func (r *TargetedManagedAppConfigurationPolicySetItemRequest) Update(ctx context.Context, reqObj *TargetedManagedAppConfigurationPolicySetItem) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for TargetedManagedAppConfigurationPolicySetItem
func (r *TargetedManagedAppConfigurationPolicySetItemRequest) Delete(ctx context.Context) error {
	return r.JSONRequest(ctx, "DELETE", "", nil, nil)
}
