...
// ExtensionSchemaPropertyRequestBuilder is request builder for ExtensionSchemaProperty
type ExtensionSchemaPropertyRequestBuilder struct{ BaseRequestBuilder }

// Request returns ExtensionSchemaPropertyRequest
func (b *ExtensionSchemaPropertyRequestBuilder) Request() *ExtensionSchemaPropertyRequest {
	return &ExtensionSchemaPropertyRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ExtensionSchemaPropertyRequest is request for ExtensionSchemaProperty
type ExtensionSchemaPropertyRequest struct{ BaseRequest }

// Get performs GET request for ExtensionSchemaProperty
func (r *ExtensionSchemaPropertyRequest) Get(ctx context.Context) (resObj *ExtensionSchemaProperty, err error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Update performs PATCH request for ExtensionSchemaProperty
func (r *ExtensionSchemaPropertyRequest) Update(ctx context.Context, reqObj *ExtensionSchemaProperty) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for ExtensionSchemaProperty
func (r *ExtensionSchemaPropertyRequest) Delete(ctx context.Context) error {
	return r.JSONRequest(ctx, "DELETE", "", nil, nil)
}
