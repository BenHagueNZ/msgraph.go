...
func NewKerberosSignOnSettings() (*KerberosSignOnSettings, error) {
	newKerberosSignOnSettings := &KerberosSignOnSettings{
		ODataType: "#microsoft.graph.KerberosSignOnSettings",
	}
...
func NewKerberosSingleSignOnExtension() (*KerberosSingleSignOnExtension, error) {
	newKerberosSingleSignOnExtension := &KerberosSingleSignOnExtension{
