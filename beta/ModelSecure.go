...
// SecureSignInSessionControl undocumented
type SecureSignInSessionControl struct {
	// ConditionalAccessSessionControl is the base model of SecureSignInSessionControl
	ConditionalAccessSessionControl

	ODataType string `json:"@odata.type,omitempty"`
}

func NewSecureSignInSessionControl() (*SecureSignInSessionControl, error) {
	newSecureSignInSessionControl := &SecureSignInSessionControl{
