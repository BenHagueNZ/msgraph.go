...
// ThreatAssessmentRequestsCountRequestBuilder is request builder for ThreatAssessmentRequestsCount
type ThreatAssessmentRequestsCountRequestBuilder struct{ BaseRequestBuilder }

// Request returns ThreatAssessmentRequestsCountRequest
func (b *ThreatAssessmentRequestsCountRequestBuilder) Request() *ThreatAssessmentRequestsCountRequest {
	return &ThreatAssessmentRequestsCountRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ThreatAssessmentRequestsCountRequest is request for ThreatAssessmentRequestsCount
type ThreatAssessmentRequestsCountRequest struct{ BaseRequest }

// Get performs GET request for ThreatAssessmentRequestsCount
func (r *ThreatAssessmentRequestsCountRequest) Get(ctx context.Context) (resObj *ThreatAssessmentRequestsCount, err error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Update performs PATCH request for ThreatAssessmentRequestsCount
func (r *ThreatAssessmentRequestsCountRequest) Update(ctx context.Context, reqObj *ThreatAssessmentRequestsCount) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for ThreatAssessmentRequestsCount
func (r *ThreatAssessmentRequestsCountRequest) Delete(ctx context.Context) error {
	return r.JSONRequest(ctx, "DELETE", "", nil, nil)
}
