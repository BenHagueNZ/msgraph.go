...
func NewAPIServicePrincipal() (*APIServicePrincipal, error) {
	newAPIServicePrincipal := &APIServicePrincipal{
		ODataType: "#microsoft.graph.ApiServicePrincipal",
	}
	return newAPIServicePrincipal, nil
}
