...
// AppleDeploymentChannel undocumented
type AppleDeploymentChannel string

const (
    // AppleDeploymentChannelVDeviceChannel undocumented
    AppleDeploymentChannelVDeviceChannel AppleDeploymentChannel = "deviceChannel"
    // AppleDeploymentChannelVUserChannel undocumented
    AppleDeploymentChannelVUserChannel AppleDeploymentChannel = "userChannel"
)

var (
    // AppleDeploymentChannelPDeviceChannel is a pointer to AppleDeploymentChannelVDeviceChannel
    AppleDeploymentChannelPDeviceChannel = &_AppleDeploymentChannelPDeviceChannel
    // AppleDeploymentChannelPUserChannel is a pointer to AppleDeploymentChannelVUserChannel
    AppleDeploymentChannelPUserChannel = &_AppleDeploymentChannelPUserChannel
)

var (
    _AppleDeploymentChannelPDeviceChannel = AppleDeploymentChannelVDeviceChannel
    _AppleDeploymentChannelPUserChannel = AppleDeploymentChannelVUserChannel
)
...
const (
    ...
    // AppleUserInitiatedEnrollmentTypeVAccountDrivenUserEnrollment undocumented
    AppleUserInitiatedEnrollmentTypeVAccountDrivenUserEnrollment AppleUserInitiatedEnrollmentType = "accountDrivenUserEnrollment"
    // AppleUserInitiatedEnrollmentTypeVWebDeviceEnrollment undocumented
    AppleUserInitiatedEnrollmentTypeVWebDeviceEnrollment AppleUserInitiatedEnrollmentType = "webDeviceEnrollment"
    // AppleUserInitiatedEnrollmentTypeVUnknownFutureValue undocumented
    AppleUserInitiatedEnrollmentTypeVUnknownFutureValue AppleUserInitiatedEnrollmentType = "unknownFutureValue"
)
...
var (
    ...
    // AppleUserInitiatedEnrollmentTypePAccountDrivenUserEnrollment is a pointer to AppleUserInitiatedEnrollmentTypeVAccountDrivenUserEnrollment
    AppleUserInitiatedEnrollmentTypePAccountDrivenUserEnrollment = &_AppleUserInitiatedEnrollmentTypePAccountDrivenUserEnrollment
    // AppleUserInitiatedEnrollmentTypePWebDeviceEnrollment is a pointer to AppleUserInitiatedEnrollmentTypeVWebDeviceEnrollment
    AppleUserInitiatedEnrollmentTypePWebDeviceEnrollment = &_AppleUserInitiatedEnrollmentTypePWebDeviceEnrollment
    // AppleUserInitiatedEnrollmentTypePUnknownFutureValue is a pointer to AppleUserInitiatedEnrollmentTypeVUnknownFutureValue
    AppleUserInitiatedEnrollmentTypePUnknownFutureValue = &_AppleUserInitiatedEnrollmentTypePUnknownFutureValue
)
...
var (
    ...
    _AppleUserInitiatedEnrollmentTypePAccountDrivenUserEnrollment = AppleUserInitiatedEnrollmentTypeVAccountDrivenUserEnrollment
    _AppleUserInitiatedEnrollmentTypePWebDeviceEnrollment = AppleUserInitiatedEnrollmentTypeVWebDeviceEnrollment
    _AppleUserInitiatedEnrollmentTypePUnknownFutureValue = AppleUserInitiatedEnrollmentTypeVUnknownFutureValue
)
