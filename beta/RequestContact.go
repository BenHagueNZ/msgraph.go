...
// ContactMergeSuggestionsRequestBuilder is request builder for ContactMergeSuggestions
type ContactMergeSuggestionsRequestBuilder struct{ BaseRequestBuilder }

// Request returns ContactMergeSuggestionsRequest
func (b *ContactMergeSuggestionsRequestBuilder) Request() *ContactMergeSuggestionsRequest {
	return &ContactMergeSuggestionsRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ContactMergeSuggestionsRequest is request for ContactMergeSuggestions
type ContactMergeSuggestionsRequest struct{ BaseRequest }

// Get performs GET request for ContactMergeSuggestions
func (r *ContactMergeSuggestionsRequest) Get(ctx context.Context) (resObj *ContactMergeSuggestions, err error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Update performs PATCH request for ContactMergeSuggestions
func (r *ContactMergeSuggestionsRequest) Update(ctx context.Context, reqObj *ContactMergeSuggestions) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for ContactMergeSuggestions
func (r *ContactMergeSuggestionsRequest) Delete(ctx context.Context) error {
	return r.JSONRequest(ctx, "DELETE", "", nil, nil)
}
