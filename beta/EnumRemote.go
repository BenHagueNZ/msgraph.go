...
const (
	...
	// RemoteActionVDeprovision undocumented
	RemoteActionVDeprovision RemoteAction = "deprovision"
	// RemoteActionVDisable undocumented
	RemoteActionVDisable RemoteAction = "disable"
	// RemoteActionVReenable undocumented
	RemoteActionVReenable RemoteAction = "reenable"
	// RemoteActionVMoveDeviceToOrganizationalUnit undocumented
	RemoteActionVMoveDeviceToOrganizationalUnit RemoteAction = "moveDeviceToOrganizationalUnit"
	// RemoteActionVInitiateMobileDeviceManagementKeyRecovery undocumented
	RemoteActionVInitiateMobileDeviceManagementKeyRecovery RemoteAction = "initiateMobileDeviceManagementKeyRecovery"
	// RemoteActionVInitiateOnDemandProactiveRemediation undocumented
	RemoteActionVInitiateOnDemandProactiveRemediation RemoteAction = "initiateOnDemandProactiveRemediation"
	// RemoteActionVRotateLocalAdminPassword undocumented
	RemoteActionVRotateLocalAdminPassword RemoteAction = "rotateLocalAdminPassword"
)
...
var (
	...
	// RemoteActionPDeprovision is a pointer to RemoteActionVDeprovision
	RemoteActionPDeprovision = &_RemoteActionPDeprovision
	// RemoteActionPDisable is a pointer to RemoteActionVDisable
	RemoteActionPDisable = &_RemoteActionPDisable
	// RemoteActionPReenable is a pointer to RemoteActionVReenable
	RemoteActionPReenable = &_RemoteActionPReenable
	// RemoteActionPMoveDeviceToOrganizationalUnit is a pointer to RemoteActionVMoveDeviceToOrganizationalUnit
	RemoteActionPMoveDeviceToOrganizationalUnit = &_RemoteActionPMoveDeviceToOrganizationalUnit
	// RemoteActionPInitiateMobileDeviceManagementKeyRecovery is a pointer to RemoteActionVInitiateMobileDeviceManagementKeyRecovery
	RemoteActionPInitiateMobileDeviceManagementKeyRecovery = &_RemoteActionPInitiateMobileDeviceManagementKeyRecovery
	// RemoteActionPInitiateOnDemandProactiveRemediation is a pointer to RemoteActionVInitiateOnDemandProactiveRemediation
	RemoteActionPInitiateOnDemandProactiveRemediation = &_RemoteActionPInitiateOnDemandProactiveRemediation
	// RemoteActionPRotateLocalAdminPassword is a pointer to RemoteActionVRotateLocalAdminPassword
	RemoteActionPRotateLocalAdminPassword = &_RemoteActionPRotateLocalAdminPassword
)
...
var (
	...
	_RemoteActionPDeprovision                               = RemoteActionVDeprovision
	_RemoteActionPDisable                                   = RemoteActionVDisable
	_RemoteActionPReenable                                  = RemoteActionVReenable
	_RemoteActionPMoveDeviceToOrganizationalUnit            = RemoteActionVMoveDeviceToOrganizationalUnit
	_RemoteActionPInitiateMobileDeviceManagementKeyRecovery = RemoteActionVInitiateMobileDeviceManagementKeyRecovery
	_RemoteActionPInitiateOnDemandProactiveRemediation      = RemoteActionVInitiateOnDemandProactiveRemediation
	_RemoteActionPRotateLocalAdminPassword                  = RemoteActionVRotateLocalAdminPassword
)
...
const (
	// RemoteAssistanceStateVDisabled undocumented
	RemoteAssistanceStateVDisabled RemoteAssistanceState = "disabled"
	// RemoteAssistanceStateVEnabled undocumented
	RemoteAssistanceStateVEnabled RemoteAssistanceState = "enabled"
)

var (
	// RemoteAssistanceStatePDisabled is a pointer to RemoteAssistanceStateVDisabled
	RemoteAssistanceStatePDisabled = &_RemoteAssistanceStatePDisabled
	// RemoteAssistanceStatePEnabled is a pointer to RemoteAssistanceStateVEnabled
	RemoteAssistanceStatePEnabled = &_RemoteAssistanceStatePEnabled
)

var (
	_RemoteAssistanceStatePDisabled = RemoteAssistanceStateVDisabled
	_RemoteAssistanceStatePEnabled  = RemoteAssistanceStateVEnabled
)
