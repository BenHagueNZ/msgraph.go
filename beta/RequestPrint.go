...
// PrintUsageSummaryRequestBuilder is request builder for PrintUsageSummary
type PrintUsageSummaryRequestBuilder struct{ BaseRequestBuilder }

// Request returns PrintUsageSummaryRequest
func (b *PrintUsageSummaryRequestBuilder) Request() *PrintUsageSummaryRequest {
	return &PrintUsageSummaryRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// PrintUsageSummaryRequest is request for PrintUsageSummary
type PrintUsageSummaryRequest struct{ BaseRequest }

// Get performs GET request for PrintUsageSummary
func (r *PrintUsageSummaryRequest) Get(ctx context.Context) (resObj *PrintUsageSummary, err error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Update performs PATCH request for PrintUsageSummary
func (r *PrintUsageSummaryRequest) Update(ctx context.Context, reqObj *PrintUsageSummary) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for PrintUsageSummary
func (r *PrintUsageSummaryRequest) Delete(ctx context.Context) error {
	return r.JSONRequest(ctx, "DELETE", "", nil, nil)
}
...
// CancelPrintJob action undocumentedrav
...
// StartPrintJob action undocumentedras
