...
// AuditUserIdentityRequestBuilder is request builder for AuditUserIdentity
type AuditUserIdentityRequestBuilder struct{ BaseRequestBuilder }

// Request returns AuditUserIdentityRequest
func (b *AuditUserIdentityRequestBuilder) Request() *AuditUserIdentityRequest {
	return &AuditUserIdentityRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// AuditUserIdentityRequest is request for AuditUserIdentity
type AuditUserIdentityRequest struct{ BaseRequest }

// Get performs GET request for AuditUserIdentity
func (r *AuditUserIdentityRequest) Get(ctx context.Context) (resObj *AuditUserIdentity, err error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Update performs PATCH request for AuditUserIdentity
func (r *AuditUserIdentityRequest) Update(ctx context.Context, reqObj *AuditUserIdentity) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for AuditUserIdentity
func (r *AuditUserIdentityRequest) Delete(ctx context.Context) error {
	return r.JSONRequest(ctx, "DELETE", "", nil, nil)
}
