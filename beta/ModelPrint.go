...
type PrintDocument struct {
	...
	// DisplayName undocumented
	DisplayName *string `json:"displayName,omitempty"`
	// DownloadedDateTime undocumented
	DownloadedDateTime *time.Time `json:"downloadedDateTime,omitempty"`
	// Size undocumented
	Size *int `json:"size,omitempty"`
	// UploadedDateTime undocumented
	UploadedDateTime *time.Time `json:"uploadedDateTime,omitempty"`
}
...
type PrintUsage struct {
	...
	// DoubleSidedSheetCount undocumented
	DoubleSidedSheetCount *int `json:"doubleSidedSheetCount,omitempty"`
	// IncompleteJobCount undocumented
	IncompleteJobCount *int `json:"incompleteJobCount,omitempty"`
	// MediaSheetCount undocumented
	MediaSheetCount *int `json:"mediaSheetCount,omitempty"`
	// PageCount undocumented
	PageCount *int `json:"pageCount,omitempty"`
	// SingleSidedSheetCount undocumented
	SingleSidedSheetCount *int `json:"singleSidedSheetCount,omitempty"`
...
// PrintUsageSummary undocumented
type PrintUsageSummary struct {
	// Object is the base model of PrintUsageSummary
	Object
...
func NewPrintUsageSummary() (*PrintUsageSummary, error) {
	newPrintUsageSummary := &PrintUsageSummary{
		ODataType: "#microsoft.graph.PrintUsageSummary",
	}
	return newPrintUsageSummary, nil
}
