...
// Fido2CombinationConfiguration undocumented
type Fido2CombinationConfiguration struct {
	// AuthenticationCombinationConfiguration is the base model of Fido2CombinationConfiguration
	AuthenticationCombinationConfiguration

	ODataType string `json:"@odata.type,omitempty"`
	// AllowedAAGUIDs undocumented
	AllowedAAGUIDs []string `json:"allowedAAGUIDs,omitempty"`
}

func NewFido2CombinationConfiguration() (*Fido2CombinationConfiguration, error) {
	newFido2CombinationConfiguration := &Fido2CombinationConfiguration{
