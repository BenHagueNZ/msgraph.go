...
// MessageMarkAsJunkRequestParameter undocumented
type MessageMarkAsJunkRequestParameter struct {
	// MoveToJunk undocumented
	MoveToJunk *bool `json:"moveToJunk,omitempty"`
}

// MessageMarkAsNotJunkRequestParameter undocumented
type MessageMarkAsNotJunkRequestParameter struct {
	// MoveToInbox undocumented
...
// MessageMentionsCollectionRequestBuilder is request builder for Mention collection rcn
...
// Events returns request builder for MessageEvent collection
func (b *MessageRecipientRequestBuilder) Events() *MessageRecipientEventsCollectionRequestBuilder {
	bb := &MessageRecipientEventsCollectionRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/events"
	return bb
}

// MessageRecipientEventsCollectionRequestBuilder is request builder for MessageEvent collection rcn
type MessageRecipientEventsCollectionRequestBuilder struct{ BaseRequestBuilder }

// Request returns request for MessageEvent collection
func (b *MessageRecipientEventsCollectionRequestBuilder) Request() *MessageRecipientEventsCollectionRequest {
	return &MessageRecipientEventsCollectionRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ID returns request builder for MessageEvent item
func (b *MessageRecipientEventsCollectionRequestBuilder) ID(id string) *MessageEventRequestBuilder {
	bb := &MessageEventRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/" + id
	return bb
}

// MessageRecipientEventsCollectionRequest is request for MessageEvent collection
type MessageRecipientEventsCollectionRequest struct{ BaseRequest }

// Paging perfoms paging operation for MessageEvent collection
func (r *MessageRecipientEventsCollectionRequest) Paging(ctx context.Context, method, path string, obj interface{}, n int) ([]MessageEvent, error) {
	req, err := r.NewJSONRequest(method, path, obj)
	if err != nil {
		return nil, err
	}
...
func (r *MessageRecipientEventsCollectionRequest) GetN(ctx context.Context, n int) ([]MessageEvent, error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
func (r *MessageRecipientEventsCollectionRequest) Get(ctx context.Context) ([]MessageEvent, error) {
	return r.GetN(ctx, 0)
}

// Add performs POST request for MessageEvent collection
func (r *MessageRecipientEventsCollectionRequest) Add(ctx context.Context, reqObj *MessageEvent) (resObj *MessageEvent, err error) {
	err = r.JSONRequest(ctx, "POST", "", reqObj, &resObj)
	return
}

// Recipients returns request builder for MessageRecipient collection
func (b *MessageTraceRequestBuilder) Recipients() *MessageTraceRecipientsCollectionRequestBuilder {
	bb := &MessageTraceRecipientsCollectionRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/recipients"
	return bb
}

// MessageTraceRecipientsCollectionRequestBuilder is request builder for MessageRecipient collection rcn
type MessageTraceRecipientsCollectionRequestBuilder struct{ BaseRequestBuilder }

// Request returns request for MessageRecipient collection
func (b *MessageTraceRecipientsCollectionRequestBuilder) Request() *MessageTraceRecipientsCollectionRequest {
	return &MessageTraceRecipientsCollectionRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ID returns request builder for MessageRecipient item
func (b *MessageTraceRecipientsCollectionRequestBuilder) ID(id string) *MessageRecipientRequestBuilder {
	bb := &MessageRecipientRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/" + id
	return bb
}

// MessageTraceRecipientsCollectionRequest is request for MessageRecipient collection
type MessageTraceRecipientsCollectionRequest struct{ BaseRequest }

// Paging perfoms paging operation for MessageRecipient collection
func (r *MessageTraceRecipientsCollectionRequest) Paging(ctx context.Context, method, path string, obj interface{}, n int) ([]MessageRecipient, error) {
	req, err := r.NewJSONRequest(method, path, obj)
	if err != nil {
		return nil, err
	}
...
func (r *MessageTraceRecipientsCollectionRequest) GetN(ctx context.Context, n int) ([]MessageRecipient, error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
func (r *MessageTraceRecipientsCollectionRequest) Get(ctx context.Context) ([]MessageRecipient, error) {
	return r.GetN(ctx, 0)
}

// Add performs POST request for MessageRecipient collection
func (r *MessageTraceRecipientsCollectionRequest) Add(ctx context.Context, reqObj *MessageRecipient) (resObj *MessageRecipient, err error) {
	err = r.JSONRequest(ctx, "POST", "", reqObj, &resObj)
	return
}

// Entity is navigation property rn
func (b *MessageEventRequestBuilder) Entity() *EntityRequestBuilder {
...
// Entity is navigation property rn
func (b *MessageRecipientRequestBuilder) Entity() *EntityRequestBuilder {
	bb := &EntityRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/Entity"
	return bb
}
...
// Entity is navigation property rn
func (b *MessageTraceRequestBuilder) Entity() *EntityRequestBuilder {
	bb := &EntityRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/Entity"
	return bb
}
