...
// IdentitySynchronization is navigation property rn
func (b *CrossTenantAccessPolicyConfigurationPartnerRequestBuilder) IdentitySynchronization() *CrossTenantIdentitySyncPolicyPartnerRequestBuilder {
	bb := &CrossTenantIdentitySyncPolicyPartnerRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/identitySynchronization"
	return bb
}
