...
// AttachmentContentPropertiesRequestBuilder is request builder for AttachmentContentProperties
type AttachmentContentPropertiesRequestBuilder struct{ BaseRequestBuilder }

// Request returns AttachmentContentPropertiesRequest
func (b *AttachmentContentPropertiesRequestBuilder) Request() *AttachmentContentPropertiesRequest {
	return &AttachmentContentPropertiesRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// AttachmentContentPropertiesRequest is request for AttachmentContentProperties
type AttachmentContentPropertiesRequest struct{ BaseRequest }

// Get performs GET request for AttachmentContentProperties
func (r *AttachmentContentPropertiesRequest) Get(ctx context.Context) (resObj *AttachmentContentProperties, err error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Update performs PATCH request for AttachmentContentProperties
func (r *AttachmentContentPropertiesRequest) Update(ctx context.Context, reqObj *AttachmentContentProperties) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for AttachmentContentProperties
func (r *AttachmentContentPropertiesRequest) Delete(ctx context.Context) error {
	return r.JSONRequest(ctx, "DELETE", "", nil, nil)
}
...
// CreateUploadSession action undocumentedras
func (b *NoteAttachmentsCollectionRequestBuilder) CreateUploadSession(reqObj *AttachmentCollectionCreateUploadSessionRequestParameter) *AttachmentCollectionCreateUploadSessionRequestBuilder {
	bb := &AttachmentCollectionCreateUploadSessionRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.BaseRequestBuilder.baseURL += "/CreateUploadSession"
	bb.BaseRequestBuilder.requestObject = reqObj
	return bb
