...
// MDMWindowsInformationProtectionPolicyPolicySetItemRequestBuilder is request builder for MDMWindowsInformationProtectionPolicyPolicySetItem
type MDMWindowsInformationProtectionPolicyPolicySetItemRequestBuilder struct{ BaseRequestBuilder }

// Request returns MDMWindowsInformationProtectionPolicyPolicySetItemRequest
func (b *MDMWindowsInformationProtectionPolicyPolicySetItemRequestBuilder) Request() *MDMWindowsInformationProtectionPolicyPolicySetItemRequest {
	return &MDMWindowsInformationProtectionPolicyPolicySetItemRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// MDMWindowsInformationProtectionPolicyPolicySetItemRequest is request for MDMWindowsInformationProtectionPolicyPolicySetItem
type MDMWindowsInformationProtectionPolicyPolicySetItemRequest struct{ BaseRequest }

// Get performs GET request for MDMWindowsInformationProtectionPolicyPolicySetItem
func (r *MDMWindowsInformationProtectionPolicyPolicySetItemRequest) Get(ctx context.Context) (resObj *MDMWindowsInformationProtectionPolicyPolicySetItem, err error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Update performs PATCH request for MDMWindowsInformationProtectionPolicyPolicySetItem
func (r *MDMWindowsInformationProtectionPolicyPolicySetItemRequest) Update(ctx context.Context, reqObj *MDMWindowsInformationProtectionPolicyPolicySetItem) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for MDMWindowsInformationProtectionPolicyPolicySetItem
func (r *MDMWindowsInformationProtectionPolicyPolicySetItemRequest) Delete(ctx context.Context) error {
	return r.JSONRequest(ctx, "DELETE", "", nil, nil)
}
