...
func NewChromeOSDeviceProperty() (*ChromeOSDeviceProperty, error) {
	newChromeOSDeviceProperty := &ChromeOSDeviceProperty{
...
func NewChromeOSOnboardingSettings() (*ChromeOSOnboardingSettings, error) {
	newChromeOSOnboardingSettings := &ChromeOSOnboardingSettings{
