...
// TeamTemplateAudience undocumented
type TeamTemplateAudience string

const (
    // TeamTemplateAudienceVOrganization undocumented
    TeamTemplateAudienceVOrganization TeamTemplateAudience = "organization"
    // TeamTemplateAudienceVUser undocumented
    TeamTemplateAudienceVUser TeamTemplateAudience = "user"
    // TeamTemplateAudienceVPublic undocumented
    TeamTemplateAudienceVPublic TeamTemplateAudience = "public"
    // TeamTemplateAudienceVUnknownFutureValue undocumented
    TeamTemplateAudienceVUnknownFutureValue TeamTemplateAudience = "unknownFutureValue"
)

var (
    // TeamTemplateAudiencePOrganization is a pointer to TeamTemplateAudienceVOrganization
    TeamTemplateAudiencePOrganization = &_TeamTemplateAudiencePOrganization
    // TeamTemplateAudiencePUser is a pointer to TeamTemplateAudienceVUser
    TeamTemplateAudiencePUser = &_TeamTemplateAudiencePUser
    // TeamTemplateAudiencePPublic is a pointer to TeamTemplateAudienceVPublic
    TeamTemplateAudiencePPublic = &_TeamTemplateAudiencePPublic
    // TeamTemplateAudiencePUnknownFutureValue is a pointer to TeamTemplateAudienceVUnknownFutureValue
    TeamTemplateAudiencePUnknownFutureValue = &_TeamTemplateAudiencePUnknownFutureValue
)

var (
    _TeamTemplateAudiencePOrganization = TeamTemplateAudienceVOrganization
    _TeamTemplateAudiencePUser = TeamTemplateAudienceVUser
    _TeamTemplateAudiencePPublic = TeamTemplateAudienceVPublic
    _TeamTemplateAudiencePUnknownFutureValue = TeamTemplateAudienceVUnknownFutureValue
)
