...
func NewPublicErrorResponse() (*PublicErrorResponse, error) {
	newPublicErrorResponse := &PublicErrorResponse{
		ODataType: "#microsoft.graph.PublicErrorResponse",
	}
	return newPublicErrorResponse, nil
}
