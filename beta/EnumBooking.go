...
// BookingStaffMembershipStatus undocumented
type BookingStaffMembershipStatus string

const (
	// BookingStaffMembershipStatusVActive undocumented
	BookingStaffMembershipStatusVActive BookingStaffMembershipStatus = "active"
	// BookingStaffMembershipStatusVPendingAcceptance undocumented
	BookingStaffMembershipStatusVPendingAcceptance BookingStaffMembershipStatus = "pendingAcceptance"
	// BookingStaffMembershipStatusVRejectedByStaff undocumented
	BookingStaffMembershipStatusVRejectedByStaff BookingStaffMembershipStatus = "rejectedByStaff"
	// BookingStaffMembershipStatusVUnknownFutureValue undocumented
	BookingStaffMembershipStatusVUnknownFutureValue BookingStaffMembershipStatus = "unknownFutureValue"
)

var (
	// BookingStaffMembershipStatusPActive is a pointer to BookingStaffMembershipStatusVActive
	BookingStaffMembershipStatusPActive = &_BookingStaffMembershipStatusPActive
	// BookingStaffMembershipStatusPPendingAcceptance is a pointer to BookingStaffMembershipStatusVPendingAcceptance
	BookingStaffMembershipStatusPPendingAcceptance = &_BookingStaffMembershipStatusPPendingAcceptance
	// BookingStaffMembershipStatusPRejectedByStaff is a pointer to BookingStaffMembershipStatusVRejectedByStaff
	BookingStaffMembershipStatusPRejectedByStaff = &_BookingStaffMembershipStatusPRejectedByStaff
	// BookingStaffMembershipStatusPUnknownFutureValue is a pointer to BookingStaffMembershipStatusVUnknownFutureValue
	BookingStaffMembershipStatusPUnknownFutureValue = &_BookingStaffMembershipStatusPUnknownFutureValue
)

var (
	_BookingStaffMembershipStatusPActive             = BookingStaffMembershipStatusVActive
	_BookingStaffMembershipStatusPPendingAcceptance  = BookingStaffMembershipStatusVPendingAcceptance
	_BookingStaffMembershipStatusPRejectedByStaff    = BookingStaffMembershipStatusVRejectedByStaff
	_BookingStaffMembershipStatusPUnknownFutureValue = BookingStaffMembershipStatusVUnknownFutureValue
)
