...
// InformationProtectionSignDigestRequestParameter undocumented
type InformationProtectionSignDigestRequestParameter struct {
	// Digest undocumented
	Digest *Binary `json:"digest,omitempty"`
}

// InformationProtectionVerifySignatureRequestParameter undocumented
type InformationProtectionVerifySignatureRequestParameter struct {
	// Digest undocumented
	Digest *Binary `json:"digest,omitempty"`
...
// InformationProtectionDataLossPreventionPoliciesCollectionRequestBuilder is request builder for DataLossPreventionPolicy collection rcn
...
// InformationProtectionSensitivityLabelsCollectionRequestBuilder is request builder for SensitivityLabel collection rcn
...
// SensitivityPolicySettings is navigation property rn
...
// InformationProtectionPolicyLabelsCollectionRequestBuilder is request builder for InformationProtectionLabel collection rcn
...
func (b *InformationProtectionRequestBuilder) Entity() *EntityRequestBuilder {
...
// Entity is navigation property rn
func (b *InformationProtectionLabelRequestBuilder) Entity() *EntityRequestBuilder {
	bb := &EntityRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/Entity"
	return bb
}
...
// Entity is navigation property rn
func (b *InformationProtectionPolicyRequestBuilder) Entity() *EntityRequestBuilder {
	bb := &EntityRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/Entity"
	return bb
}
