...
// CrossTenantAccessPolicyTenantRestrictionsRequestBuilder is request builder for CrossTenantAccessPolicyTenantRestrictions
type CrossTenantAccessPolicyTenantRestrictionsRequestBuilder struct{ BaseRequestBuilder }

// Request returns CrossTenantAccessPolicyTenantRestrictionsRequest
func (b *CrossTenantAccessPolicyTenantRestrictionsRequestBuilder) Request() *CrossTenantAccessPolicyTenantRestrictionsRequest {
	return &CrossTenantAccessPolicyTenantRestrictionsRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// CrossTenantAccessPolicyTenantRestrictionsRequest is request for CrossTenantAccessPolicyTenantRestrictions
type CrossTenantAccessPolicyTenantRestrictionsRequest struct{ BaseRequest }

// Get performs GET request for CrossTenantAccessPolicyTenantRestrictions
func (r *CrossTenantAccessPolicyTenantRestrictionsRequest) Get(ctx context.Context) (resObj *CrossTenantAccessPolicyTenantRestrictions, err error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Update performs PATCH request for CrossTenantAccessPolicyTenantRestrictions
func (r *CrossTenantAccessPolicyTenantRestrictionsRequest) Update(ctx context.Context, reqObj *CrossTenantAccessPolicyTenantRestrictions) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for CrossTenantAccessPolicyTenantRestrictions
func (r *CrossTenantAccessPolicyTenantRestrictionsRequest) Delete(ctx context.Context) error {
	return r.JSONRequest(ctx, "DELETE", "", nil, nil)
}

// CrossTenantIdentitySyncPolicyPartnerRequestBuilder is request builder for CrossTenantIdentitySyncPolicyPartner
type CrossTenantIdentitySyncPolicyPartnerRequestBuilder struct{ BaseRequestBuilder }

// Request returns CrossTenantIdentitySyncPolicyPartnerRequest
func (b *CrossTenantIdentitySyncPolicyPartnerRequestBuilder) Request() *CrossTenantIdentitySyncPolicyPartnerRequest {
	return &CrossTenantIdentitySyncPolicyPartnerRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// CrossTenantIdentitySyncPolicyPartnerRequest is request for CrossTenantIdentitySyncPolicyPartner
type CrossTenantIdentitySyncPolicyPartnerRequest struct{ BaseRequest }

// Get performs GET request for CrossTenantIdentitySyncPolicyPartner
func (r *CrossTenantIdentitySyncPolicyPartnerRequest) Get(ctx context.Context) (resObj *CrossTenantIdentitySyncPolicyPartner, err error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Update performs PATCH request for CrossTenantIdentitySyncPolicyPartner
func (r *CrossTenantIdentitySyncPolicyPartnerRequest) Update(ctx context.Context, reqObj *CrossTenantIdentitySyncPolicyPartner) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for CrossTenantIdentitySyncPolicyPartner
func (r *CrossTenantIdentitySyncPolicyPartnerRequest) Delete(ctx context.Context) error {
	return r.JSONRequest(ctx, "DELETE", "", nil, nil)
}

// CrossTenantUserSyncInboundRequestBuilder is request builder for CrossTenantUserSyncInbound
type CrossTenantUserSyncInboundRequestBuilder struct{ BaseRequestBuilder }

// Request returns CrossTenantUserSyncInboundRequest
func (b *CrossTenantUserSyncInboundRequestBuilder) Request() *CrossTenantUserSyncInboundRequest {
	return &CrossTenantUserSyncInboundRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// CrossTenantUserSyncInboundRequest is request for CrossTenantUserSyncInbound
type CrossTenantUserSyncInboundRequest struct{ BaseRequest }

// Get performs GET request for CrossTenantUserSyncInbound
func (r *CrossTenantUserSyncInboundRequest) Get(ctx context.Context) (resObj *CrossTenantUserSyncInbound, err error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Update performs PATCH request for CrossTenantUserSyncInbound
func (r *CrossTenantUserSyncInboundRequest) Update(ctx context.Context, reqObj *CrossTenantUserSyncInbound) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for CrossTenantUserSyncInbound
func (r *CrossTenantUserSyncInboundRequest) Delete(ctx context.Context) error {
	return r.JSONRequest(ctx, "DELETE", "", nil, nil)
}
