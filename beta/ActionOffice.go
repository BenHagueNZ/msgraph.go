...
// OfficeClientConfigurationAssignmentsCollectionRequestBuilder is request builder for OfficeClientConfigurationAssignment collection rcn
...
// OfficeConfigurationClientConfigurationsCollectionRequestBuilder is request builder for OfficeClientConfiguration collection rcn
...
func (b *OfficeClientConfigurationRequestBuilder) Entity() *EntityRequestBuilder {
...
// Entity is navigation property rn
func (b *OfficeClientConfigurationAssignmentRequestBuilder) Entity() *EntityRequestBuilder {
	bb := &EntityRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/Entity"
	return bb
}
...
// OfficeSuiteApp returns request builder for OfficeSuiteApp collection
func (b *DeviceAppManagementMobileAppsCollectionRequestBuilder) OfficeSuiteApp() *DeviceAppManagementMobileAppsCollectionOfficeSuiteAppCollectionRequestBuilder {
	bb := &DeviceAppManagementMobileAppsCollectionOfficeSuiteAppCollectionRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/"
	return bb
}

// DeviceAppManagementMobileAppsCollectionOfficeSuiteAppCollectionRequestBuilder is request builder for OfficeSuiteApp collection rcn
type DeviceAppManagementMobileAppsCollectionOfficeSuiteAppCollectionRequestBuilder struct{ BaseRequestBuilder }

// Request returns request for OfficeSuiteApp collection
func (b *DeviceAppManagementMobileAppsCollectionOfficeSuiteAppCollectionRequestBuilder) Request() *DeviceAppManagementMobileAppsCollectionOfficeSuiteAppCollectionRequest {
	return &DeviceAppManagementMobileAppsCollectionOfficeSuiteAppCollectionRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ID returns request builder for OfficeSuiteApp item
func (b *DeviceAppManagementMobileAppsCollectionOfficeSuiteAppCollectionRequestBuilder) ID(id string) *OfficeSuiteAppRequestBuilder {
	bb := &OfficeSuiteAppRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/" + id
	return bb
}

// DeviceAppManagementMobileAppsCollectionOfficeSuiteAppCollectionRequest is request for OfficeSuiteApp collection
type DeviceAppManagementMobileAppsCollectionOfficeSuiteAppCollectionRequest struct{ BaseRequest }

// Paging perfoms paging operation for OfficeSuiteApp collection
func (r *DeviceAppManagementMobileAppsCollectionOfficeSuiteAppCollectionRequest) Paging(ctx context.Context, method, path string, obj interface{}, n int) ([]OfficeSuiteApp, error) {
	req, err := r.NewJSONRequest(method, path, obj)
	if err != nil {
		return nil, err
	}
...
// GetN performs GET request for OfficeSuiteApp collection, max N pages
func (r *DeviceAppManagementMobileAppsCollectionOfficeSuiteAppCollectionRequest) GetN(ctx context.Context, n int) ([]OfficeSuiteApp, error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Get performs GET request for OfficeSuiteApp collection
func (r *DeviceAppManagementMobileAppsCollectionOfficeSuiteAppCollectionRequest) Get(ctx context.Context) ([]OfficeSuiteApp, error) {
	return r.GetN(ctx, 0)
}

// Add performs POST request for OfficeSuiteApp collection
func (r *DeviceAppManagementMobileAppsCollectionOfficeSuiteAppCollectionRequest) Add(ctx context.Context, reqObj *OfficeSuiteApp) (resObj *OfficeSuiteApp, err error) {
	err = r.JSONRequest(ctx, "POST", "", reqObj, &resObj)
	return
}
