...
// ProgramResourceRequestBuilder is request builder for ProgramResource
type ProgramResourceRequestBuilder struct{ BaseRequestBuilder }

// Request returns ProgramResourceRequest
func (b *ProgramResourceRequestBuilder) Request() *ProgramResourceRequest {
	return &ProgramResourceRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ProgramResourceRequest is request for ProgramResource
type ProgramResourceRequest struct{ BaseRequest }

// Get performs GET request for ProgramResource
func (r *ProgramResourceRequest) Get(ctx context.Context) (resObj *ProgramResource, err error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Update performs PATCH request for ProgramResource
func (r *ProgramResourceRequest) Update(ctx context.Context, reqObj *ProgramResource) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for ProgramResource
func (r *ProgramResourceRequest) Delete(ctx context.Context) error {
	return r.JSONRequest(ctx, "DELETE", "", nil, nil)
}
