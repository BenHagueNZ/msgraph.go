...
// ChatMessageActions undocumented
type ChatMessageActions string

const (
	// ChatMessageActionsVReactionAdded undocumented
	ChatMessageActionsVReactionAdded ChatMessageActions = "reactionAdded"
	// ChatMessageActionsVReactionRemoved undocumented
	ChatMessageActionsVReactionRemoved ChatMessageActions = "reactionRemoved"
	// ChatMessageActionsVActionUndefined undocumented
	ChatMessageActionsVActionUndefined ChatMessageActions = "actionUndefined"
	// ChatMessageActionsVUnknownFutureValue undocumented
	ChatMessageActionsVUnknownFutureValue ChatMessageActions = "unknownFutureValue"
)

var (
	// ChatMessageActionsPReactionAdded is a pointer to ChatMessageActionsVReactionAdded
	ChatMessageActionsPReactionAdded = &_ChatMessageActionsPReactionAdded
	// ChatMessageActionsPReactionRemoved is a pointer to ChatMessageActionsVReactionRemoved
	ChatMessageActionsPReactionRemoved = &_ChatMessageActionsPReactionRemoved
	// ChatMessageActionsPActionUndefined is a pointer to ChatMessageActionsVActionUndefined
	ChatMessageActionsPActionUndefined = &_ChatMessageActionsPActionUndefined
	// ChatMessageActionsPUnknownFutureValue is a pointer to ChatMessageActionsVUnknownFutureValue
	ChatMessageActionsPUnknownFutureValue = &_ChatMessageActionsPUnknownFutureValue
)

var (
	_ChatMessageActionsPReactionAdded      = ChatMessageActionsVReactionAdded
	_ChatMessageActionsPReactionRemoved    = ChatMessageActionsVReactionRemoved
	_ChatMessageActionsPActionUndefined    = ChatMessageActionsVActionUndefined
	_ChatMessageActionsPUnknownFutureValue = ChatMessageActionsVUnknownFutureValue
)
