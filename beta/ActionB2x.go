...
// B2xIdentityUserFlow returns request builder for B2xIdentityUserFlow collection
func (b *IdentityContainerUserFlowsCollectionRequestBuilder) B2xIdentityUserFlow() *IdentityContainerUserFlowsCollectionB2xIdentityUserFlowCollectionRequestBuilder {
	bb := &IdentityContainerUserFlowsCollectionB2xIdentityUserFlowCollectionRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/"
	return bb
}

// IdentityContainerUserFlowsCollectionB2xIdentityUserFlowCollectionRequestBuilder is request builder for B2xIdentityUserFlow collection rcn
type IdentityContainerUserFlowsCollectionB2xIdentityUserFlowCollectionRequestBuilder struct{ BaseRequestBuilder }

// Request returns request for B2xIdentityUserFlow collection
func (b *IdentityContainerUserFlowsCollectionB2xIdentityUserFlowCollectionRequestBuilder) Request() *IdentityContainerUserFlowsCollectionB2xIdentityUserFlowCollectionRequest {
	return &IdentityContainerUserFlowsCollectionB2xIdentityUserFlowCollectionRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ID returns request builder for B2xIdentityUserFlow item
func (b *IdentityContainerUserFlowsCollectionB2xIdentityUserFlowCollectionRequestBuilder) ID(id string) *B2xIdentityUserFlowRequestBuilder {
	bb := &B2xIdentityUserFlowRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/" + id
	return bb
}

// IdentityContainerUserFlowsCollectionB2xIdentityUserFlowCollectionRequest is request for B2xIdentityUserFlow collection
type IdentityContainerUserFlowsCollectionB2xIdentityUserFlowCollectionRequest struct{ BaseRequest }

// Paging perfoms paging operation for B2xIdentityUserFlow collection
func (r *IdentityContainerUserFlowsCollectionB2xIdentityUserFlowCollectionRequest) Paging(ctx context.Context, method, path string, obj interface{}, n int) ([]B2xIdentityUserFlow, error) {
	req, err := r.NewJSONRequest(method, path, obj)
	if err != nil {
		return nil, err
	}
...
func (r *IdentityContainerUserFlowsCollectionB2xIdentityUserFlowCollectionRequest) GetN(ctx context.Context, n int) ([]B2xIdentityUserFlow, error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
func (r *IdentityContainerUserFlowsCollectionB2xIdentityUserFlowCollectionRequest) Get(ctx context.Context) ([]B2xIdentityUserFlow, error) {
	return r.GetN(ctx, 0)
}

// Add performs POST request for B2xIdentityUserFlow collection
func (r *IdentityContainerUserFlowsCollectionB2xIdentityUserFlowCollectionRequest) Add(ctx context.Context, reqObj *B2xIdentityUserFlow) (resObj *B2xIdentityUserFlow, err error) {
	err = r.JSONRequest(ctx, "POST", "", reqObj, &resObj)
	return
}
