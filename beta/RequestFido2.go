...
// Fido2CombinationConfigurationRequestBuilder is request builder for Fido2CombinationConfiguration
type Fido2CombinationConfigurationRequestBuilder struct{ BaseRequestBuilder }

// Request returns Fido2CombinationConfigurationRequest
func (b *Fido2CombinationConfigurationRequestBuilder) Request() *Fido2CombinationConfigurationRequest {
	return &Fido2CombinationConfigurationRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// Fido2CombinationConfigurationRequest is request for Fido2CombinationConfiguration
type Fido2CombinationConfigurationRequest struct{ BaseRequest }

// Get performs GET request for Fido2CombinationConfiguration
func (r *Fido2CombinationConfigurationRequest) Get(ctx context.Context) (resObj *Fido2CombinationConfiguration, err error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Update performs PATCH request for Fido2CombinationConfiguration
func (r *Fido2CombinationConfigurationRequest) Update(ctx context.Context, reqObj *Fido2CombinationConfiguration) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for Fido2CombinationConfiguration
func (r *Fido2CombinationConfigurationRequest) Delete(ctx context.Context) error {
	return r.JSONRequest(ctx, "DELETE", "", nil, nil)
}
