...
// Fido2CombinationConfiguration returns request builder for Fido2CombinationConfiguration collection
func (b *AuthenticationStrengthPolicyCombinationConfigurationsCollectionRequestBuilder) Fido2CombinationConfiguration() *AuthenticationStrengthPolicyCombinationConfigurationsCollectionFido2CombinationConfigurationCollectionRequestBuilder {
	bb := &AuthenticationStrengthPolicyCombinationConfigurationsCollectionFido2CombinationConfigurationCollectionRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/"
	return bb
}

// AuthenticationStrengthPolicyCombinationConfigurationsCollectionFido2CombinationConfigurationCollectionRequestBuilder is request builder for Fido2CombinationConfiguration collection rcn
type AuthenticationStrengthPolicyCombinationConfigurationsCollectionFido2CombinationConfigurationCollectionRequestBuilder struct{ BaseRequestBuilder }

// Request returns request for Fido2CombinationConfiguration collection
func (b *AuthenticationStrengthPolicyCombinationConfigurationsCollectionFido2CombinationConfigurationCollectionRequestBuilder) Request() *AuthenticationStrengthPolicyCombinationConfigurationsCollectionFido2CombinationConfigurationCollectionRequest {
	return &AuthenticationStrengthPolicyCombinationConfigurationsCollectionFido2CombinationConfigurationCollectionRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ID returns request builder for Fido2CombinationConfiguration item
func (b *AuthenticationStrengthPolicyCombinationConfigurationsCollectionFido2CombinationConfigurationCollectionRequestBuilder) ID(id string) *Fido2CombinationConfigurationRequestBuilder {
	bb := &Fido2CombinationConfigurationRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/" + id
	return bb
}

// AuthenticationStrengthPolicyCombinationConfigurationsCollectionFido2CombinationConfigurationCollectionRequest is request for Fido2CombinationConfiguration collection
type AuthenticationStrengthPolicyCombinationConfigurationsCollectionFido2CombinationConfigurationCollectionRequest struct{ BaseRequest }

// Paging perfoms paging operation for Fido2CombinationConfiguration collection
func (r *AuthenticationStrengthPolicyCombinationConfigurationsCollectionFido2CombinationConfigurationCollectionRequest) Paging(ctx context.Context, method, path string, obj interface{}, n int) ([]Fido2CombinationConfiguration, error) {
	req, err := r.NewJSONRequest(method, path, obj)
	if err != nil {
		return nil, err
	}
	...
	var values []Fido2CombinationConfiguration
	for {
		if res.StatusCode != http.StatusOK {
			b, _ := ioutil.ReadAll(res.Body)
			res.Body.Close()
		...
		var (
			paging Paging
			value  []Fido2CombinationConfiguration
		)
		err := jsonx.NewDecoder(res.Body).Decode(&paging)
		res.Body.Close()
		if err != nil {
...
// GetN performs GET request for Fido2CombinationConfiguration collection, max N pages
func (r *AuthenticationStrengthPolicyCombinationConfigurationsCollectionFido2CombinationConfigurationCollectionRequest) GetN(ctx context.Context, n int) ([]Fido2CombinationConfiguration, error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Get performs GET request for Fido2CombinationConfiguration collection
func (r *AuthenticationStrengthPolicyCombinationConfigurationsCollectionFido2CombinationConfigurationCollectionRequest) Get(ctx context.Context) ([]Fido2CombinationConfiguration, error) {
	return r.GetN(ctx, 0)
}

// Add performs POST request for Fido2CombinationConfiguration collection
func (r *AuthenticationStrengthPolicyCombinationConfigurationsCollectionFido2CombinationConfigurationCollectionRequest) Add(ctx context.Context, reqObj *Fido2CombinationConfiguration) (resObj *Fido2CombinationConfiguration, err error) {
	err = r.JSONRequest(ctx, "POST", "", reqObj, &resObj)
	return
}
