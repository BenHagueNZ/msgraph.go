...
func NewPrinterDocumentConfiguration() (*PrinterDocumentConfiguration, error) {
	newPrinterDocumentConfiguration := &PrinterDocumentConfiguration{
...
func NewPrinterShareViewpoint() (*PrinterShareViewpoint, error) {
	newPrinterShareViewpoint := &PrinterShareViewpoint{
		ODataType: "#microsoft.graph.PrinterShareViewpoint",
	}
...
func NewPrinterUsageSummary() (*PrinterUsageSummary, error) {
	newPrinterUsageSummary := &PrinterUsageSummary{
