...
func NewRegionalAndLanguageSettings() (*RegionalAndLanguageSettings, error) {
	newRegionalAndLanguageSettings := &RegionalAndLanguageSettings{
		ODataType: "#microsoft.graph.RegionalAndLanguageSettings",
	}
...
func NewRegionalFormatOverrides() (*RegionalFormatOverrides, error) {
	newRegionalFormatOverrides := &RegionalFormatOverrides{
