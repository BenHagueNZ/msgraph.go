...
// PublicErrorResponseRequestBuilder is request builder for PublicErrorResponse
type PublicErrorResponseRequestBuilder struct{ BaseRequestBuilder }

// Request returns PublicErrorResponseRequest
func (b *PublicErrorResponseRequestBuilder) Request() *PublicErrorResponseRequest {
	return &PublicErrorResponseRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// PublicErrorResponseRequest is request for PublicErrorResponse
type PublicErrorResponseRequest struct{ BaseRequest }

// Get performs GET request for PublicErrorResponse
func (r *PublicErrorResponseRequest) Get(ctx context.Context) (resObj *PublicErrorResponse, err error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Update performs PATCH request for PublicErrorResponse
func (r *PublicErrorResponseRequest) Update(ctx context.Context, reqObj *PublicErrorResponse) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for PublicErrorResponse
func (r *PublicErrorResponseRequest) Delete(ctx context.Context) error {
	return r.JSONRequest(ctx, "DELETE", "", nil, nil)
}
