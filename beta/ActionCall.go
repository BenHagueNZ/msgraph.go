...
// CallActivityStatistics returns request builder for CallActivityStatistics collection
func (b *UserAnalyticsActivityStatisticsCollectionRequestBuilder) CallActivityStatistics() *UserAnalyticsActivityStatisticsCollectionCallActivityStatisticsCollectionRequestBuilder {
	bb := &UserAnalyticsActivityStatisticsCollectionCallActivityStatisticsCollectionRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/"
	return bb
}

// UserAnalyticsActivityStatisticsCollectionCallActivityStatisticsCollectionRequestBuilder is request builder for CallActivityStatistics collection rcn
type UserAnalyticsActivityStatisticsCollectionCallActivityStatisticsCollectionRequestBuilder struct{ BaseRequestBuilder }

// Request returns request for CallActivityStatistics collection
func (b *UserAnalyticsActivityStatisticsCollectionCallActivityStatisticsCollectionRequestBuilder) Request() *UserAnalyticsActivityStatisticsCollectionCallActivityStatisticsCollectionRequest {
	return &UserAnalyticsActivityStatisticsCollectionCallActivityStatisticsCollectionRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ID returns request builder for CallActivityStatistics item
func (b *UserAnalyticsActivityStatisticsCollectionCallActivityStatisticsCollectionRequestBuilder) ID(id string) *CallActivityStatisticsRequestBuilder {
	bb := &CallActivityStatisticsRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/" + id
	return bb
}

// UserAnalyticsActivityStatisticsCollectionCallActivityStatisticsCollectionRequest is request for CallActivityStatistics collection
type UserAnalyticsActivityStatisticsCollectionCallActivityStatisticsCollectionRequest struct{ BaseRequest }

// Paging perfoms paging operation for CallActivityStatistics collection
func (r *UserAnalyticsActivityStatisticsCollectionCallActivityStatisticsCollectionRequest) Paging(ctx context.Context, method, path string, obj interface{}, n int) ([]CallActivityStatistics, error) {
	req, err := r.NewJSONRequest(method, path, obj)
	if err != nil {
		return nil, err
	}
	...
	var values []CallActivityStatistics
	for {
		if res.StatusCode != http.StatusOK {
			b, _ := ioutil.ReadAll(res.Body)
			res.Body.Close()
...
// GetN performs GET request for CallActivityStatistics collection, max N pages
func (r *UserAnalyticsActivityStatisticsCollectionCallActivityStatisticsCollectionRequest) GetN(ctx context.Context, n int) ([]CallActivityStatistics, error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Get performs GET request for CallActivityStatistics collection
func (r *UserAnalyticsActivityStatisticsCollectionCallActivityStatisticsCollectionRequest) Get(ctx context.Context) ([]CallActivityStatistics, error) {
	return r.GetN(ctx, 0)
}

// Add performs POST request for CallActivityStatistics collection
func (r *UserAnalyticsActivityStatisticsCollectionCallActivityStatisticsCollectionRequest) Add(ctx context.Context, reqObj *CallActivityStatistics) (resObj *CallActivityStatistics, err error) {
	err = r.JSONRequest(ctx, "POST", "", reqObj, &resObj)
	return
}

// Entity is navigation property rn
func (b *CallTranscriptRequestBuilder) Entity() *EntityRequestBuilder {
	bb := &EntityRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/Entity"
	return bb
}
