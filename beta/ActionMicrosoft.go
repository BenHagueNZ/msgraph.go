...
// MicrosoftTunnelServerGenerateServerLogCollectionRequestActionRequestParameter undocumented
type MicrosoftTunnelServerGenerateServerLogCollectionRequestActionRequestParameter struct {
	// StartDateTime undocumented
	StartDateTime *time.Time `json:"startDateTime,omitempty"`
	// EndDateTime undocumented
	EndDateTime *time.Time `json:"endDateTime,omitempty"`
...
// MicrosoftTunnelServerLogCollectionResponseGenerateDownloadURLRequestParameter undocumented
type MicrosoftTunnelServerLogCollectionResponseGenerateDownloadURLRequestParameter struct {
}
...
// MicrosoftStoreForBusinessAppContainedAppsCollectionRequestBuilder is request builder for MobileContainedApp collection rcn
...
// MicrosoftTunnelConfiguration is navigation property rn
...
// MicrosoftTunnelSiteMicrosoftTunnelServersCollectionRequestBuilder is request builder for MicrosoftTunnelServer collection rcn
...
func (b *MicrosoftApplicationDataAccessSettingsRequestBuilder) Entity() *EntityRequestBuilder {
...
// MicrosoftStoreForBusinessContainedApp returns request builder for MicrosoftStoreForBusinessContainedApp collection
func (b *MicrosoftStoreForBusinessAppContainedAppsCollectionRequestBuilder) MicrosoftStoreForBusinessContainedApp() *MicrosoftStoreForBusinessAppContainedAppsCollectionMicrosoftStoreForBusinessContainedAppCollectionRequestBuilder {
	bb := &MicrosoftStoreForBusinessAppContainedAppsCollectionMicrosoftStoreForBusinessContainedAppCollectionRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/"
	return bb
}

// MicrosoftStoreForBusinessAppContainedAppsCollectionMicrosoftStoreForBusinessContainedAppCollectionRequestBuilder is request builder for MicrosoftStoreForBusinessContainedApp collection rcn
type MicrosoftStoreForBusinessAppContainedAppsCollectionMicrosoftStoreForBusinessContainedAppCollectionRequestBuilder struct{ BaseRequestBuilder }

// Request returns request for MicrosoftStoreForBusinessContainedApp collection
func (b *MicrosoftStoreForBusinessAppContainedAppsCollectionMicrosoftStoreForBusinessContainedAppCollectionRequestBuilder) Request() *MicrosoftStoreForBusinessAppContainedAppsCollectionMicrosoftStoreForBusinessContainedAppCollectionRequest {
	return &MicrosoftStoreForBusinessAppContainedAppsCollectionMicrosoftStoreForBusinessContainedAppCollectionRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ID returns request builder for MicrosoftStoreForBusinessContainedApp item
func (b *MicrosoftStoreForBusinessAppContainedAppsCollectionMicrosoftStoreForBusinessContainedAppCollectionRequestBuilder) ID(id string) *MicrosoftStoreForBusinessContainedAppRequestBuilder {
	bb := &MicrosoftStoreForBusinessContainedAppRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/" + id
	return bb
}

// MicrosoftStoreForBusinessAppContainedAppsCollectionMicrosoftStoreForBusinessContainedAppCollectionRequest is request for MicrosoftStoreForBusinessContainedApp collection
type MicrosoftStoreForBusinessAppContainedAppsCollectionMicrosoftStoreForBusinessContainedAppCollectionRequest struct{ BaseRequest }

// Paging perfoms paging operation for MicrosoftStoreForBusinessContainedApp collection
func (r *MicrosoftStoreForBusinessAppContainedAppsCollectionMicrosoftStoreForBusinessContainedAppCollectionRequest) Paging(ctx context.Context, method, path string, obj interface{}, n int) ([]MicrosoftStoreForBusinessContainedApp, error) {
	req, err := r.NewJSONRequest(method, path, obj)
	if err != nil {
		return nil, err
	}
	...
	var values []MicrosoftStoreForBusinessContainedApp
	for {
		if res.StatusCode != http.StatusOK {
			b, _ := ioutil.ReadAll(res.Body)
			res.Body.Close()
		...
		var (
			paging Paging
			value  []MicrosoftStoreForBusinessContainedApp
		)
		err := jsonx.NewDecoder(res.Body).Decode(&paging)
		res.Body.Close()
		if err != nil {
...
// GetN performs GET request for MicrosoftStoreForBusinessContainedApp collection, max N pages
func (r *MicrosoftStoreForBusinessAppContainedAppsCollectionMicrosoftStoreForBusinessContainedAppCollectionRequest) GetN(ctx context.Context, n int) ([]MicrosoftStoreForBusinessContainedApp, error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Get performs GET request for MicrosoftStoreForBusinessContainedApp collection
func (r *MicrosoftStoreForBusinessAppContainedAppsCollectionMicrosoftStoreForBusinessContainedAppCollectionRequest) Get(ctx context.Context) ([]MicrosoftStoreForBusinessContainedApp, error) {
	return r.GetN(ctx, 0)
}

// Add performs POST request for MicrosoftStoreForBusinessContainedApp collection
func (r *MicrosoftStoreForBusinessAppContainedAppsCollectionMicrosoftStoreForBusinessContainedAppCollectionRequest) Add(ctx context.Context, reqObj *MicrosoftStoreForBusinessContainedApp) (resObj *MicrosoftStoreForBusinessContainedApp, err error) {
	err = r.JSONRequest(ctx, "POST", "", reqObj, &resObj)
	return
}

// Entity is navigation property rn
func (b *MicrosoftTunnelConfigurationRequestBuilder) Entity() *EntityRequestBuilder {
	bb := &EntityRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/Entity"
	return bb
}
...
// Entity is navigation property rn
func (b *MicrosoftTunnelHealthThresholdRequestBuilder) Entity() *EntityRequestBuilder {
	bb := &EntityRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/Entity"
	return bb
}
...
// Entity is navigation property rn
func (b *MicrosoftTunnelServerRequestBuilder) Entity() *EntityRequestBuilder {
	bb := &EntityRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/Entity"
	return bb
}
...
// Entity is navigation property rn
func (b *MicrosoftTunnelServerLogCollectionResponseRequestBuilder) Entity() *EntityRequestBuilder {
	bb := &EntityRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/Entity"
	return bb
}
...
// Entity is navigation property rn
func (b *MicrosoftTunnelSiteRequestBuilder) Entity() *EntityRequestBuilder {
	bb := &EntityRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/Entity"
	return bb
}
...
// Entity is navigation property rn
func (b *MicrosoftStoreForBusinessAppContainedAppsCollectionRequestBuilder) Entity() *EntityRequestBuilder {
	bb := &EntityRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/Entity"
	return bb
}
