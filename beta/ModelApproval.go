...
func NewApprovalStep() (*ApprovalStep, error) {
	newApprovalStep := &ApprovalStep{
...
func NewApprovalWorkflowProvider() (*ApprovalWorkflowProvider, error) {
	newApprovalWorkflowProvider := &ApprovalWorkflowProvider{
