...
func NewChatActivityStatistics() (*ChatActivityStatistics, error) {
	newChatActivityStatistics := &ChatActivityStatistics{
...
// ChatMessageHistoryItem undocumented
type ChatMessageHistoryItem struct {
	// Object is the base model of ChatMessageHistoryItem
	Object
	...
	// Reaction undocumented
	Reaction *ChatMessageReaction `json:"reaction,omitempty"`
}

func NewChatMessageHistoryItem() (*ChatMessageHistoryItem, error) {
	newChatMessageHistoryItem := &ChatMessageHistoryItem{
