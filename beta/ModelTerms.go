...
// TermsAndConditionsGroupAssignment undocumented
...
func NewTermsAndConditionsGroupAssignment() (*TermsAndConditionsGroupAssignment, error) {
	newTermsAndConditionsGroupAssignment := &TermsAndConditionsGroupAssignment{
		ODataType: "#microsoft.graph.TermsAndConditionsGroupAssignment",
	}
