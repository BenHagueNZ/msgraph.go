...
// OrgContactRetryServiceProvisioningRequestParameter undocumented
type OrgContactRetryServiceProvisioningRequestParameter struct {
}
...
func (b *OrgContactRequestBuilder) TransitiveReports() *OrgContactTransitiveReportsCollectionRequestBuilder {
	bb := &OrgContactTransitiveReportsCollectionRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/transitiveReports"
	return bb
}

// OrgContactTransitiveReportsCollectionRequestBuilder is request builder for DirectoryObject collection rcn
type OrgContactTransitiveReportsCollectionRequestBuilder struct{ BaseRequestBuilder }

// Request returns request for DirectoryObject collection
func (b *OrgContactTransitiveReportsCollectionRequestBuilder) Request() *OrgContactTransitiveReportsCollectionRequest {
	return &OrgContactTransitiveReportsCollectionRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ID returns request builder for DirectoryObject item
func (b *OrgContactTransitiveReportsCollectionRequestBuilder) ID(id string) *DirectoryObjectRequestBuilder {
	bb := &DirectoryObjectRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/" + id
	return bb
}

// OrgContactTransitiveReportsCollectionRequest is request for DirectoryObject collection
type OrgContactTransitiveReportsCollectionRequest struct{ BaseRequest }

// Paging perfoms paging operation for DirectoryObject collection
func (r *OrgContactTransitiveReportsCollectionRequest) Paging(ctx context.Context, method, path string, obj interface{}, n int) ([]DirectoryObject, error) {
	req, err := r.NewJSONRequest(method, path, obj)
	if err != nil {
		return nil, err
	}
...
// GetN performs GET request for DirectoryObject collection, max N pages
func (r *OrgContactTransitiveReportsCollectionRequest) GetN(ctx context.Context, n int) ([]DirectoryObject, error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Get performs GET request for DirectoryObject collection
func (r *OrgContactTransitiveReportsCollectionRequest) Get(ctx context.Context) ([]DirectoryObject, error) {
	return r.GetN(ctx, 0)
}

// Add performs POST request for DirectoryObject collection
func (r *OrgContactTransitiveReportsCollectionRequest) Add(ctx context.Context, reqObj *DirectoryObject) (resObj *DirectoryObject, err error) {
	err = r.JSONRequest(ctx, "POST", "", reqObj, &resObj)
	return
}

// OrgContact returns request builder for OrgContact collection
func (b *AdministrativeUnitMembersCollectionRequestBuilder) OrgContact() *AdministrativeUnitMembersCollectionOrgContactCollectionRequestBuilder {
	bb := &AdministrativeUnitMembersCollectionOrgContactCollectionRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/"
	return bb
}
...
func (b *AdministrativeUnitMembersCollectionOrgContactCollectionRequestBuilder) Request() *AdministrativeUnitMembersCollectionOrgContactCollectionRequest {
	return &AdministrativeUnitMembersCollectionOrgContactCollectionRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ID returns request builder for OrgContact item
func (b *AdministrativeUnitMembersCollectionOrgContactCollectionRequestBuilder) ID(id string) *OrgContactRequestBuilder {
	bb := &OrgContactRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/" + id
	return bb
}

// AdministrativeUnitMembersCollectionOrgContactCollectionRequest is request for OrgContact collection
type AdministrativeUnitMembersCollectionOrgContactCollectionRequest struct{ BaseRequest }

// Paging perfoms paging operation for OrgContact collection
func (r *AdministrativeUnitMembersCollectionOrgContactCollectionRequest) Paging(ctx context.Context, method, path string, obj interface{}, n int) ([]OrgContact, error) {
	req, err := r.NewJSONRequest(method, path, obj)
	if err != nil {
		return nil, err
	}
...
func (r *AdministrativeUnitMembersCollectionOrgContactCollectionRequest) GetN(ctx context.Context, n int) ([]OrgContact, error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
func (r *AdministrativeUnitMembersCollectionOrgContactCollectionRequest) Get(ctx context.Context) ([]OrgContact, error) {
	return r.GetN(ctx, 0)
}

// Add performs POST request for OrgContact collection
func (r *AdministrativeUnitMembersCollectionOrgContactCollectionRequest) Add(ctx context.Context, reqObj *OrgContact) (resObj *OrgContact, err error) {
	err = r.JSONRequest(ctx, "POST", "", reqObj, &resObj)
	return
}
