...
// ConnectedOrganizationExternalSponsorsCollectionRequestBuilder is request builder for DirectoryObject collection rcn
...
// ConnectedOrganizationInternalSponsorsCollectionRequestBuilder is request builder for DirectoryObject collection rcn
