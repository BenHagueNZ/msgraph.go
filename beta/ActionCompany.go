...
// CompanyAccountsCollectionRequestBuilder is request builder for Account collection rcn
...
// CompanyAgedAccountsPayableCollectionRequestBuilder is request builder for AgedAccountsPayable collection rcn
...
// CompanyAgedAccountsReceivableCollectionRequestBuilder is request builder for AgedAccountsReceivable collection rcn
...
// CompanyCompanyInformationCollectionRequestBuilder is request builder for CompanyInformation collection rcn
...
// CompanyCountriesRegionsCollectionRequestBuilder is request builder for CountryRegion collection rcn
...
// CompanyCurrenciesCollectionRequestBuilder is request builder for Currency collection rcn
...
// CompanyCustomerPaymentJournalsCollectionRequestBuilder is request builder for CustomerPaymentJournal collection rcn
...
// CompanyCustomerPaymentsCollectionRequestBuilder is request builder for CustomerPayment collection rcn
...
// CompanyCustomersCollectionRequestBuilder is request builder for Customer collection rcn
...
// CompanyDimensionValuesCollectionRequestBuilder is request builder for DimensionValue collection rcn
...
// CompanyDimensionsCollectionRequestBuilder is request builder for Dimension collection rcn
...
// CompanyEmployeesCollectionRequestBuilder is request builder for Employee collection rcn
...
// CompanyGeneralLedgerEntriesCollectionRequestBuilder is request builder for GeneralLedgerEntry collection rcn
...
// CompanyItemCategoriesCollectionRequestBuilder is request builder for ItemCategory collection rcn
...
// CompanyItemsCollectionRequestBuilder is request builder for Item collection rcn
...
// CompanyJournalLinesCollectionRequestBuilder is request builder for JournalLine collection rcn
...
// CompanyJournalsCollectionRequestBuilder is request builder for Journal collection rcn
...
// CompanyPaymentMethodsCollectionRequestBuilder is request builder for PaymentMethod collection rcn
...
// CompanyPaymentTermsCollectionRequestBuilder is request builder for PaymentTerm collection rcn
...
// CompanyPictureCollectionRequestBuilder is request builder for Picture collection rcn
...
// CompanyPurchaseInvoiceLinesCollectionRequestBuilder is request builder for PurchaseInvoiceLine collection rcn
...
// CompanyPurchaseInvoicesCollectionRequestBuilder is request builder for PurchaseInvoice collection rcn
...
// CompanySalesCreditMemoLinesCollectionRequestBuilder is request builder for SalesCreditMemoLine collection rcn
...
// CompanySalesCreditMemosCollectionRequestBuilder is request builder for SalesCreditMemo collection rcn
...
// CompanySalesInvoiceLinesCollectionRequestBuilder is request builder for SalesInvoiceLine collection rcn
...
// CompanySalesInvoicesCollectionRequestBuilder is request builder for SalesInvoice collection rcn
...
// CompanySalesOrderLinesCollectionRequestBuilder is request builder for SalesOrderLine collection rcn
...
// CompanySalesOrdersCollectionRequestBuilder is request builder for SalesOrder collection rcn
...
// CompanySalesQuoteLinesCollectionRequestBuilder is request builder for SalesQuoteLine collection rcn
...
// CompanySalesQuotesCollectionRequestBuilder is request builder for SalesQuote collection rcn
...
// CompanyShipmentMethodsCollectionRequestBuilder is request builder for ShipmentMethod collection rcn
...
// CompanyTaxAreasCollectionRequestBuilder is request builder for TaxArea collection rcn
...
// CompanyTaxGroupsCollectionRequestBuilder is request builder for TaxGroup collection rcn
...
// CompanyUnitsOfMeasureCollectionRequestBuilder is request builder for UnitOfMeasure collection rcn
...
// CompanyVendorsCollectionRequestBuilder is request builder for Vendor collection rcn
...
func (b *CompanyRequestBuilder) Entity() *EntityRequestBuilder {
...
// Entity is navigation property rn
func (b *CompanyInformationRequestBuilder) Entity() *EntityRequestBuilder {
	bb := &EntityRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/Entity"
	return bb
}
