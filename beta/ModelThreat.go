...
func NewThreatAssessmentRequestsCount() (*ThreatAssessmentRequestsCount, error) {
	newThreatAssessmentRequestsCount := &ThreatAssessmentRequestsCount{
		ODataType: "#microsoft.graph.ThreatAssessmentRequestsCount",
	}
	return newThreatAssessmentRequestsCount, nil
}
