...
// PresenceStatusMessageRequestBuilder is request builder for PresenceStatusMessage
type PresenceStatusMessageRequestBuilder struct{ BaseRequestBuilder }

// Request returns PresenceStatusMessageRequest
func (b *PresenceStatusMessageRequestBuilder) Request() *PresenceStatusMessageRequest {
	return &PresenceStatusMessageRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// PresenceStatusMessageRequest is request for PresenceStatusMessage
type PresenceStatusMessageRequest struct{ BaseRequest }

// Get performs GET request for PresenceStatusMessage
func (r *PresenceStatusMessageRequest) Get(ctx context.Context) (resObj *PresenceStatusMessage, err error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Update performs PATCH request for PresenceStatusMessage
func (r *PresenceStatusMessageRequest) Update(ctx context.Context, reqObj *PresenceStatusMessage) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for PresenceStatusMessage
func (r *PresenceStatusMessageRequest) Delete(ctx context.Context) error {
	return r.JSONRequest(ctx, "DELETE", "", nil, nil)
}
...
type PresenceSetStatusMessageRequestBuilder struct{ BaseRequestBuilder }

// SetStatusMessage action undocumentedrav
func (b *PresenceRequestBuilder) SetStatusMessage(reqObj *PresenceSetStatusMessageRequestParameter) *PresenceSetStatusMessageRequestBuilder {
	bb := &PresenceSetStatusMessageRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.BaseRequestBuilder.baseURL += "/SetStatusMessage"
	bb.BaseRequestBuilder.requestObject = reqObj
	return bb
}

type PresenceSetStatusMessageRequest struct{ BaseRequest }

func (b *PresenceSetStatusMessageRequestBuilder) Request() *PresenceSetStatusMessageRequest {
	return &PresenceSetStatusMessageRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client, requestObject: b.requestObject},
	}
}

func (r *PresenceSetStatusMessageRequest) Post(ctx context.Context) error {
	return r.JSONRequest(ctx, "POST", "", r.requestObject, nil)
}
