...
// PrintJobCancelPrintJobRequestParameter undocumented
type PrintJobCancelPrintJobRequestParameter struct {
}
...
// PrintJobStartPrintJobRequestParameter undocumented
type PrintJobStartPrintJobRequestParameter struct {
}
...
// PrinterShares returns request builder for PrinterShare collection
func (b *PrintRequestBuilder) PrinterShares() *PrintPrinterSharesCollectionRequestBuilder {
	bb := &PrintPrinterSharesCollectionRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/printerShares"
	return bb
}

// PrintPrinterSharesCollectionRequestBuilder is request builder for PrinterShare collection rcn
type PrintPrinterSharesCollectionRequestBuilder struct{ BaseRequestBuilder }

// Request returns request for PrinterShare collection
func (b *PrintPrinterSharesCollectionRequestBuilder) Request() *PrintPrinterSharesCollectionRequest {
	return &PrintPrinterSharesCollectionRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ID returns request builder for PrinterShare item
func (b *PrintPrinterSharesCollectionRequestBuilder) ID(id string) *PrinterShareRequestBuilder {
	bb := &PrinterShareRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/" + id
	return bb
}

// PrintPrinterSharesCollectionRequest is request for PrinterShare collection
type PrintPrinterSharesCollectionRequest struct{ BaseRequest }

// Paging perfoms paging operation for PrinterShare collection
func (r *PrintPrinterSharesCollectionRequest) Paging(ctx context.Context, method, path string, obj interface{}, n int) ([]PrinterShare, error) {
	req, err := r.NewJSONRequest(method, path, obj)
	if err != nil {
		return nil, err
	}
...
func (r *PrintPrinterSharesCollectionRequest) GetN(ctx context.Context, n int) ([]PrinterShare, error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
func (r *PrintPrinterSharesCollectionRequest) Get(ctx context.Context) ([]PrinterShare, error) {
	return r.GetN(ctx, 0)
}

// Add performs POST request for PrinterShare collection
func (r *PrintPrinterSharesCollectionRequest) Add(ctx context.Context, reqObj *PrinterShare) (resObj *PrinterShare, err error) {
	err = r.JSONRequest(ctx, "POST", "", reqObj, &resObj)
	return
}
...
// PrintUsageByPrinter returns request builder for PrintUsageByPrinter collection
func (b *ReportRootDailyPrintUsageCollectionRequestBuilder) PrintUsageByPrinter() *ReportRootDailyPrintUsageCollectionPrintUsageByPrinterCollectionRequestBuilder {
	bb := &ReportRootDailyPrintUsageCollectionPrintUsageByPrinterCollectionRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/"
	return bb
}

// ReportRootDailyPrintUsageCollectionPrintUsageByPrinterCollectionRequestBuilder is request builder for PrintUsageByPrinter collection rcn
type ReportRootDailyPrintUsageCollectionPrintUsageByPrinterCollectionRequestBuilder struct{ BaseRequestBuilder }

// Request returns request for PrintUsageByPrinter collection
func (b *ReportRootDailyPrintUsageCollectionPrintUsageByPrinterCollectionRequestBuilder) Request() *ReportRootDailyPrintUsageCollectionPrintUsageByPrinterCollectionRequest {
	return &ReportRootDailyPrintUsageCollectionPrintUsageByPrinterCollectionRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ID returns request builder for PrintUsageByPrinter item
func (b *ReportRootDailyPrintUsageCollectionPrintUsageByPrinterCollectionRequestBuilder) ID(id string) *PrintUsageByPrinterRequestBuilder {
	bb := &PrintUsageByPrinterRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/" + id
	return bb
}

// ReportRootDailyPrintUsageCollectionPrintUsageByPrinterCollectionRequest is request for PrintUsageByPrinter collection
type ReportRootDailyPrintUsageCollectionPrintUsageByPrinterCollectionRequest struct{ BaseRequest }

// Paging perfoms paging operation for PrintUsageByPrinter collection
func (r *ReportRootDailyPrintUsageCollectionPrintUsageByPrinterCollectionRequest) Paging(ctx context.Context, method, path string, obj interface{}, n int) ([]PrintUsageByPrinter, error) {
	req, err := r.NewJSONRequest(method, path, obj)
	if err != nil {
		return nil, err
	}
...
func (r *ReportRootDailyPrintUsageCollectionPrintUsageByPrinterCollectionRequest) GetN(ctx context.Context, n int) ([]PrintUsageByPrinter, error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
func (r *ReportRootDailyPrintUsageCollectionPrintUsageByPrinterCollectionRequest) Get(ctx context.Context) ([]PrintUsageByPrinter, error) {
	return r.GetN(ctx, 0)
}

// Add performs POST request for PrintUsageByPrinter collection
func (r *ReportRootDailyPrintUsageCollectionPrintUsageByPrinterCollectionRequest) Add(ctx context.Context, reqObj *PrintUsageByPrinter) (resObj *PrintUsageByPrinter, err error) {
	err = r.JSONRequest(ctx, "POST", "", reqObj, &resObj)
	return
}

// PrintUsageByUser returns request builder for PrintUsageByUser collection
func (b *ReportRootDailyPrintUsageCollectionRequestBuilder) PrintUsageByUser() *ReportRootDailyPrintUsageCollectionPrintUsageByUserCollectionRequestBuilder {
	bb := &ReportRootDailyPrintUsageCollectionPrintUsageByUserCollectionRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/"
	return bb
}

// ReportRootDailyPrintUsageCollectionPrintUsageByUserCollectionRequestBuilder is request builder for PrintUsageByUser collection rcn
type ReportRootDailyPrintUsageCollectionPrintUsageByUserCollectionRequestBuilder struct{ BaseRequestBuilder }

// Request returns request for PrintUsageByUser collection
func (b *ReportRootDailyPrintUsageCollectionPrintUsageByUserCollectionRequestBuilder) Request() *ReportRootDailyPrintUsageCollectionPrintUsageByUserCollectionRequest {
	return &ReportRootDailyPrintUsageCollectionPrintUsageByUserCollectionRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ID returns request builder for PrintUsageByUser item
func (b *ReportRootDailyPrintUsageCollectionPrintUsageByUserCollectionRequestBuilder) ID(id string) *PrintUsageByUserRequestBuilder {
	bb := &PrintUsageByUserRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/" + id
	return bb
}

// ReportRootDailyPrintUsageCollectionPrintUsageByUserCollectionRequest is request for PrintUsageByUser collection
type ReportRootDailyPrintUsageCollectionPrintUsageByUserCollectionRequest struct{ BaseRequest }

// Paging perfoms paging operation for PrintUsageByUser collection
func (r *ReportRootDailyPrintUsageCollectionPrintUsageByUserCollectionRequest) Paging(ctx context.Context, method, path string, obj interface{}, n int) ([]PrintUsageByUser, error) {
	req, err := r.NewJSONRequest(method, path, obj)
	if err != nil {
		return nil, err
	}
...
func (r *ReportRootDailyPrintUsageCollectionPrintUsageByUserCollectionRequest) GetN(ctx context.Context, n int) ([]PrintUsageByUser, error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
func (r *ReportRootDailyPrintUsageCollectionPrintUsageByUserCollectionRequest) Get(ctx context.Context) ([]PrintUsageByUser, error) {
	return r.GetN(ctx, 0)
}

// Add performs POST request for PrintUsageByUser collection
func (r *ReportRootDailyPrintUsageCollectionPrintUsageByUserCollectionRequest) Add(ctx context.Context, reqObj *PrintUsageByUser) (resObj *PrintUsageByUser, err error) {
	err = r.JSONRequest(ctx, "POST", "", reqObj, &resObj)
	return
}
