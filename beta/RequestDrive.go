...
// DriveItemSourceRequestBuilder is request builder for DriveItemSource
type DriveItemSourceRequestBuilder struct{ BaseRequestBuilder }

// Request returns DriveItemSourceRequest
func (b *DriveItemSourceRequestBuilder) Request() *DriveItemSourceRequest {
	return &DriveItemSourceRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// DriveItemSourceRequest is request for DriveItemSource
type DriveItemSourceRequest struct{ BaseRequest }

// Get performs GET request for DriveItemSource
func (r *DriveItemSourceRequest) Get(ctx context.Context) (resObj *DriveItemSource, err error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Update performs PATCH request for DriveItemSource
func (r *DriveItemSourceRequest) Update(ctx context.Context, reqObj *DriveItemSource) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for DriveItemSource
func (r *DriveItemSourceRequest) Delete(ctx context.Context) error {
	return r.JSONRequest(ctx, "DELETE", "", nil, nil)
}
...
type DriveItemAssignSensitivityLabelRequestBuilder struct{ BaseRequestBuilder }

// AssignSensitivityLabel action undocumentedrav
func (b *DriveItemRequestBuilder) AssignSensitivityLabel(reqObj *DriveItemAssignSensitivityLabelRequestParameter) *DriveItemAssignSensitivityLabelRequestBuilder {
	bb := &DriveItemAssignSensitivityLabelRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.BaseRequestBuilder.baseURL += "/AssignSensitivityLabel"
	bb.BaseRequestBuilder.requestObject = reqObj
	return bb
}

type DriveItemAssignSensitivityLabelRequest struct{ BaseRequest }

func (b *DriveItemAssignSensitivityLabelRequestBuilder) Request() *DriveItemAssignSensitivityLabelRequest {
	return &DriveItemAssignSensitivityLabelRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client, requestObject: b.requestObject},
	}
}

func (r *DriveItemAssignSensitivityLabelRequest) Post(ctx context.Context) error {
...
type DriveItemExtractSensitivityLabelsRequestBuilder struct{ BaseRequestBuilder }

// ExtractSensitivityLabels action undocumentedras
func (b *DriveItemRequestBuilder) ExtractSensitivityLabels(reqObj *DriveItemExtractSensitivityLabelsRequestParameter) *DriveItemExtractSensitivityLabelsRequestBuilder {
	bb := &DriveItemExtractSensitivityLabelsRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.BaseRequestBuilder.baseURL += "/ExtractSensitivityLabels"
	bb.BaseRequestBuilder.requestObject = reqObj
	return bb
}

type DriveItemExtractSensitivityLabelsRequest struct{ BaseRequest }

func (b *DriveItemExtractSensitivityLabelsRequestBuilder) Request() *DriveItemExtractSensitivityLabelsRequest {
	return &DriveItemExtractSensitivityLabelsRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client, requestObject: b.requestObject},
	}
}

func (r *DriveItemExtractSensitivityLabelsRequest) Post(ctx context.Context) (resObj *ExtractSensitivityLabelsResult, err error) {
	err = r.JSONRequest(ctx, "POST", "", r.requestObject, &resObj)
	return
}
