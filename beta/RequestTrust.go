...
// TrustFrameworkKeyRequestBuilder is request builder for TrustFrameworkKey
type TrustFrameworkKeyRequestBuilder struct{ BaseRequestBuilder }

// Request returns TrustFrameworkKeyRequest
func (b *TrustFrameworkKeyRequestBuilder) Request() *TrustFrameworkKeyRequest {
	return &TrustFrameworkKeyRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// TrustFrameworkKeyRequest is request for TrustFrameworkKey
type TrustFrameworkKeyRequest struct{ BaseRequest }

// Get performs GET request for TrustFrameworkKey
func (r *TrustFrameworkKeyRequest) Get(ctx context.Context) (resObj *TrustFrameworkKey, err error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Update performs PATCH request for TrustFrameworkKey
func (r *TrustFrameworkKeyRequest) Update(ctx context.Context, reqObj *TrustFrameworkKey) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for TrustFrameworkKey
func (r *TrustFrameworkKeyRequest) Delete(ctx context.Context) error {
	return r.JSONRequest(ctx, "DELETE", "", nil, nil)
}
...
// GenerateKey action undocumentedras
...
// UploadCertificate action undocumentedras
...
// UploadPkcs12 action undocumentedras
...
// UploadSecret action undocumentedras
