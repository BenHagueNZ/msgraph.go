...
// SensitivityLabelAssignmentRequestBuilder is request builder for SensitivityLabelAssignment
type SensitivityLabelAssignmentRequestBuilder struct{ BaseRequestBuilder }

// Request returns SensitivityLabelAssignmentRequest
func (b *SensitivityLabelAssignmentRequestBuilder) Request() *SensitivityLabelAssignmentRequest {
	return &SensitivityLabelAssignmentRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// SensitivityLabelAssignmentRequest is request for SensitivityLabelAssignment
type SensitivityLabelAssignmentRequest struct{ BaseRequest }

// Get performs GET request for SensitivityLabelAssignment
func (r *SensitivityLabelAssignmentRequest) Get(ctx context.Context) (resObj *SensitivityLabelAssignment, err error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Update performs PATCH request for SensitivityLabelAssignment
func (r *SensitivityLabelAssignmentRequest) Update(ctx context.Context, reqObj *SensitivityLabelAssignment) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for SensitivityLabelAssignment
func (r *SensitivityLabelAssignmentRequest) Delete(ctx context.Context) error {
	return r.JSONRequest(ctx, "DELETE", "", nil, nil)
}
