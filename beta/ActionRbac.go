...
// RbacApplicationResourceNamespacesCollectionRequestBuilder is request builder for UnifiedRbacResourceNamespace collection rcn
...
// RoleAssignmentApprovals returns request builder for Approval collection
func (b *RbacApplicationRequestBuilder) RoleAssignmentApprovals() *RbacApplicationRoleAssignmentApprovalsCollectionRequestBuilder {
	bb := &RbacApplicationRoleAssignmentApprovalsCollectionRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/roleAssignmentApprovals"
	return bb
}

// RbacApplicationRoleAssignmentApprovalsCollectionRequestBuilder is request builder for Approval collection rcn
type RbacApplicationRoleAssignmentApprovalsCollectionRequestBuilder struct{ BaseRequestBuilder }

// Request returns request for Approval collection
func (b *RbacApplicationRoleAssignmentApprovalsCollectionRequestBuilder) Request() *RbacApplicationRoleAssignmentApprovalsCollectionRequest {
	return &RbacApplicationRoleAssignmentApprovalsCollectionRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ID returns request builder for Approval item
func (b *RbacApplicationRoleAssignmentApprovalsCollectionRequestBuilder) ID(id string) *ApprovalRequestBuilder {
	bb := &ApprovalRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/" + id
	return bb
}

// RbacApplicationRoleAssignmentApprovalsCollectionRequest is request for Approval collection
type RbacApplicationRoleAssignmentApprovalsCollectionRequest struct{ BaseRequest }

// Paging perfoms paging operation for Approval collection
func (r *RbacApplicationRoleAssignmentApprovalsCollectionRequest) Paging(ctx context.Context, method, path string, obj interface{}, n int) ([]Approval, error) {
	req, err := r.NewJSONRequest(method, path, obj)
	if err != nil {
		return nil, err
	}
...
func (r *RbacApplicationRoleAssignmentApprovalsCollectionRequest) GetN(ctx context.Context, n int) ([]Approval, error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
func (r *RbacApplicationRoleAssignmentApprovalsCollectionRequest) Get(ctx context.Context) ([]Approval, error) {
	return r.GetN(ctx, 0)
}

// Add performs POST request for Approval collection
func (r *RbacApplicationRoleAssignmentApprovalsCollectionRequest) Add(ctx context.Context, reqObj *Approval) (resObj *Approval, err error) {
	err = r.JSONRequest(ctx, "POST", "", reqObj, &resObj)
	return
}
...
func (b *RbacApplicationRequestBuilder) TransitiveRoleAssignments() *RbacApplicationTransitiveRoleAssignmentsCollectionRequestBuilder {
	bb := &RbacApplicationTransitiveRoleAssignmentsCollectionRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/transitiveRoleAssignments"
	return bb
}

// RbacApplicationTransitiveRoleAssignmentsCollectionRequestBuilder is request builder for UnifiedRoleAssignment collection rcn
type RbacApplicationTransitiveRoleAssignmentsCollectionRequestBuilder struct{ BaseRequestBuilder }

// Request returns request for UnifiedRoleAssignment collection
func (b *RbacApplicationTransitiveRoleAssignmentsCollectionRequestBuilder) Request() *RbacApplicationTransitiveRoleAssignmentsCollectionRequest {
	return &RbacApplicationTransitiveRoleAssignmentsCollectionRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ID returns request builder for UnifiedRoleAssignment item
func (b *RbacApplicationTransitiveRoleAssignmentsCollectionRequestBuilder) ID(id string) *UnifiedRoleAssignmentRequestBuilder {
	bb := &UnifiedRoleAssignmentRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/" + id
	return bb
}

// RbacApplicationTransitiveRoleAssignmentsCollectionRequest is request for UnifiedRoleAssignment collection
type RbacApplicationTransitiveRoleAssignmentsCollectionRequest struct{ BaseRequest }

// Paging perfoms paging operation for UnifiedRoleAssignment collection
func (r *RbacApplicationTransitiveRoleAssignmentsCollectionRequest) Paging(ctx context.Context, method, path string, obj interface{}, n int) ([]UnifiedRoleAssignment, error) {
	req, err := r.NewJSONRequest(method, path, obj)
	if err != nil {
		return nil, err
	}
...
// GetN performs GET request for UnifiedRoleAssignment collection, max N pages
func (r *RbacApplicationTransitiveRoleAssignmentsCollectionRequest) GetN(ctx context.Context, n int) ([]UnifiedRoleAssignment, error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Get performs GET request for UnifiedRoleAssignment collection
func (r *RbacApplicationTransitiveRoleAssignmentsCollectionRequest) Get(ctx context.Context) ([]UnifiedRoleAssignment, error) {
	return r.GetN(ctx, 0)
}

// Add performs POST request for UnifiedRoleAssignment collection
func (r *RbacApplicationTransitiveRoleAssignmentsCollectionRequest) Add(ctx context.Context, reqObj *UnifiedRoleAssignment) (resObj *UnifiedRoleAssignment, err error) {
	err = r.JSONRequest(ctx, "POST", "", reqObj, &resObj)
	return
}
...
// RbacApplicationMultipleResourceNamespacesCollectionRequestBuilder is request builder for UnifiedRbacResourceNamespace collection rcn
...
// RbacApplicationMultipleRoleAssignmentsCollectionRequestBuilder is request builder for UnifiedRoleAssignmentMultiple collection rcn
...
// RbacApplicationMultipleRoleDefinitionsCollectionRequestBuilder is request builder for UnifiedRoleDefinition collection rcn
...
// Entity is navigation property rn
func (b *RbacApplicationMultipleRequestBuilder) Entity() *EntityRequestBuilder {
	bb := &EntityRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/Entity"
	return bb
}
