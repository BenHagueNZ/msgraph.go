...
// SoftwareOathAuthenticationMethodConfiguration undocumented
type SoftwareOathAuthenticationMethodConfiguration struct {
	// AuthenticationMethodConfiguration is the base model of SoftwareOathAuthenticationMethodConfiguration
...
func NewSoftwareOathAuthenticationMethodConfiguration() (*SoftwareOathAuthenticationMethodConfiguration, error) {
	newSoftwareOathAuthenticationMethodConfiguration := &SoftwareOathAuthenticationMethodConfiguration{
