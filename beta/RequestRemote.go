...
// RemoteAssistanceSettingsRequestBuilder is request builder for RemoteAssistanceSettings
type RemoteAssistanceSettingsRequestBuilder struct{ BaseRequestBuilder }

// Request returns RemoteAssistanceSettingsRequest
func (b *RemoteAssistanceSettingsRequestBuilder) Request() *RemoteAssistanceSettingsRequest {
	return &RemoteAssistanceSettingsRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// RemoteAssistanceSettingsRequest is request for RemoteAssistanceSettings
type RemoteAssistanceSettingsRequest struct{ BaseRequest }

// Get performs GET request for RemoteAssistanceSettings
func (r *RemoteAssistanceSettingsRequest) Get(ctx context.Context) (resObj *RemoteAssistanceSettings, err error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Update performs PATCH request for RemoteAssistanceSettings
func (r *RemoteAssistanceSettingsRequest) Update(ctx context.Context, reqObj *RemoteAssistanceSettings) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for RemoteAssistanceSettings
func (r *RemoteAssistanceSettingsRequest) Delete(ctx context.Context) error {
	return r.JSONRequest(ctx, "DELETE", "", nil, nil)
}
