...
// OutlookGeoCoordinatesRequestBuilder is request builder for OutlookGeoCoordinates
type OutlookGeoCoordinatesRequestBuilder struct{ BaseRequestBuilder }

// Request returns OutlookGeoCoordinatesRequest
func (b *OutlookGeoCoordinatesRequestBuilder) Request() *OutlookGeoCoordinatesRequest {
	return &OutlookGeoCoordinatesRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// OutlookGeoCoordinatesRequest is request for OutlookGeoCoordinates
type OutlookGeoCoordinatesRequest struct{ BaseRequest }

// Get performs GET request for OutlookGeoCoordinates
func (r *OutlookGeoCoordinatesRequest) Get(ctx context.Context) (resObj *OutlookGeoCoordinates, err error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Update performs PATCH request for OutlookGeoCoordinates
func (r *OutlookGeoCoordinatesRequest) Update(ctx context.Context, reqObj *OutlookGeoCoordinates) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for OutlookGeoCoordinates
func (r *OutlookGeoCoordinatesRequest) Delete(ctx context.Context) error {
	return r.JSONRequest(ctx, "DELETE", "", nil, nil)
}
...
// Complete action undocumentedrac
