...
// EntitlementManagementAccessPackageAssignmentPoliciesCollectionRequestBuilder is request builder for AccessPackageAssignmentPolicy collection rcn
...
// EntitlementManagementAccessPackageAssignmentRequestsCollectionRequestBuilder is request builder for AccessPackageAssignmentRequestObject collection rcn
...
// EntitlementManagementAccessPackageAssignmentResourceRolesCollectionRequestBuilder is request builder for AccessPackageAssignmentResourceRole collection rcn
...
// EntitlementManagementAccessPackageAssignmentsCollectionRequestBuilder is request builder for AccessPackageAssignment collection rcn
...
// EntitlementManagementAccessPackageCatalogsCollectionRequestBuilder is request builder for AccessPackageCatalog collection rcn
...
// EntitlementManagementAccessPackageResourceEnvironmentsCollectionRequestBuilder is request builder for AccessPackageResourceEnvironment collection rcn
...
// EntitlementManagementAccessPackageResourceRequestsCollectionRequestBuilder is request builder for AccessPackageResourceRequestObject collection rcn
...
// EntitlementManagementAccessPackageResourceRoleScopesCollectionRequestBuilder is request builder for AccessPackageResourceRoleScope collection rcn
...
// EntitlementManagementAccessPackageResourcesCollectionRequestBuilder is request builder for AccessPackageResource collection rcn
...
// Subjects returns request builder for AccessPackageSubject collection
func (b *EntitlementManagementRequestBuilder) Subjects() *EntitlementManagementSubjectsCollectionRequestBuilder {
	bb := &EntitlementManagementSubjectsCollectionRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/subjects"
	return bb
}

// EntitlementManagementSubjectsCollectionRequestBuilder is request builder for AccessPackageSubject collection rcn
type EntitlementManagementSubjectsCollectionRequestBuilder struct{ BaseRequestBuilder }

// Request returns request for AccessPackageSubject collection
func (b *EntitlementManagementSubjectsCollectionRequestBuilder) Request() *EntitlementManagementSubjectsCollectionRequest {
	return &EntitlementManagementSubjectsCollectionRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ID returns request builder for AccessPackageSubject item
func (b *EntitlementManagementSubjectsCollectionRequestBuilder) ID(id string) *AccessPackageSubjectRequestBuilder {
	bb := &AccessPackageSubjectRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/" + id
	return bb
}

// EntitlementManagementSubjectsCollectionRequest is request for AccessPackageSubject collection
type EntitlementManagementSubjectsCollectionRequest struct{ BaseRequest }

// Paging perfoms paging operation for AccessPackageSubject collection
func (r *EntitlementManagementSubjectsCollectionRequest) Paging(ctx context.Context, method, path string, obj interface{}, n int) ([]AccessPackageSubject, error) {
	req, err := r.NewJSONRequest(method, path, obj)
	if err != nil {
		return nil, err
	}
...
// GetN performs GET request for AccessPackageSubject collection, max N pages
func (r *EntitlementManagementSubjectsCollectionRequest) GetN(ctx context.Context, n int) ([]AccessPackageSubject, error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
func (r *EntitlementManagementSubjectsCollectionRequest) Get(ctx context.Context) ([]AccessPackageSubject, error) {
	return r.GetN(ctx, 0)
}

// Add performs POST request for AccessPackageSubject collection
func (r *EntitlementManagementSubjectsCollectionRequest) Add(ctx context.Context, reqObj *AccessPackageSubject) (resObj *AccessPackageSubject, err error) {
	err = r.JSONRequest(ctx, "POST", "", reqObj, &resObj)
	return
}
