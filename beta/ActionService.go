...
// ServicePrincipalLicenseDetailsCollectionRequestBuilder is request builder for LicenseDetails collection rcn
...
// Excludes returns request builder for ServicePrincipalCreationConditionSet collection
func (b *ServicePrincipalCreationPolicyRequestBuilder) Excludes() *ServicePrincipalCreationPolicyExcludesCollectionRequestBuilder {
	bb := &ServicePrincipalCreationPolicyExcludesCollectionRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/excludes"
	return bb
}

// ServicePrincipalCreationPolicyExcludesCollectionRequestBuilder is request builder for ServicePrincipalCreationConditionSet collection rcn
type ServicePrincipalCreationPolicyExcludesCollectionRequestBuilder struct{ BaseRequestBuilder }

// Request returns request for ServicePrincipalCreationConditionSet collection
func (b *ServicePrincipalCreationPolicyExcludesCollectionRequestBuilder) Request() *ServicePrincipalCreationPolicyExcludesCollectionRequest {
	return &ServicePrincipalCreationPolicyExcludesCollectionRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ID returns request builder for ServicePrincipalCreationConditionSet item
func (b *ServicePrincipalCreationPolicyExcludesCollectionRequestBuilder) ID(id string) *ServicePrincipalCreationConditionSetRequestBuilder {
	bb := &ServicePrincipalCreationConditionSetRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/" + id
	return bb
}

// ServicePrincipalCreationPolicyExcludesCollectionRequest is request for ServicePrincipalCreationConditionSet collection
type ServicePrincipalCreationPolicyExcludesCollectionRequest struct{ BaseRequest }

// Paging perfoms paging operation for ServicePrincipalCreationConditionSet collection
func (r *ServicePrincipalCreationPolicyExcludesCollectionRequest) Paging(ctx context.Context, method, path string, obj interface{}, n int) ([]ServicePrincipalCreationConditionSet, error) {
	req, err := r.NewJSONRequest(method, path, obj)
	if err != nil {
		return nil, err
	}
	...
	var values []ServicePrincipalCreationConditionSet
	for {
		if res.StatusCode != http.StatusOK {
			b, _ := ioutil.ReadAll(res.Body)
			res.Body.Close()
		...
		var (
			paging Paging
			value  []ServicePrincipalCreationConditionSet
		)
		err := jsonx.NewDecoder(res.Body).Decode(&paging)
		res.Body.Close()
		if err != nil {
...
// GetN performs GET request for ServicePrincipalCreationConditionSet collection, max N pages
func (r *ServicePrincipalCreationPolicyExcludesCollectionRequest) GetN(ctx context.Context, n int) ([]ServicePrincipalCreationConditionSet, error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Get performs GET request for ServicePrincipalCreationConditionSet collection
func (r *ServicePrincipalCreationPolicyExcludesCollectionRequest) Get(ctx context.Context) ([]ServicePrincipalCreationConditionSet, error) {
	return r.GetN(ctx, 0)
}

// Add performs POST request for ServicePrincipalCreationConditionSet collection
func (r *ServicePrincipalCreationPolicyExcludesCollectionRequest) Add(ctx context.Context, reqObj *ServicePrincipalCreationConditionSet) (resObj *ServicePrincipalCreationConditionSet, err error) {
	err = r.JSONRequest(ctx, "POST", "", reqObj, &resObj)
	return
}

// Includes returns request builder for ServicePrincipalCreationConditionSet collection
func (b *ServicePrincipalCreationPolicyRequestBuilder) Includes() *ServicePrincipalCreationPolicyIncludesCollectionRequestBuilder {
	bb := &ServicePrincipalCreationPolicyIncludesCollectionRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/includes"
	return bb
}

// ServicePrincipalCreationPolicyIncludesCollectionRequestBuilder is request builder for ServicePrincipalCreationConditionSet collection rcn
type ServicePrincipalCreationPolicyIncludesCollectionRequestBuilder struct{ BaseRequestBuilder }

// Request returns request for ServicePrincipalCreationConditionSet collection
func (b *ServicePrincipalCreationPolicyIncludesCollectionRequestBuilder) Request() *ServicePrincipalCreationPolicyIncludesCollectionRequest {
	return &ServicePrincipalCreationPolicyIncludesCollectionRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ID returns request builder for ServicePrincipalCreationConditionSet item
func (b *ServicePrincipalCreationPolicyIncludesCollectionRequestBuilder) ID(id string) *ServicePrincipalCreationConditionSetRequestBuilder {
	bb := &ServicePrincipalCreationConditionSetRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/" + id
	return bb
}

// ServicePrincipalCreationPolicyIncludesCollectionRequest is request for ServicePrincipalCreationConditionSet collection
type ServicePrincipalCreationPolicyIncludesCollectionRequest struct{ BaseRequest }

// Paging perfoms paging operation for ServicePrincipalCreationConditionSet collection
func (r *ServicePrincipalCreationPolicyIncludesCollectionRequest) Paging(ctx context.Context, method, path string, obj interface{}, n int) ([]ServicePrincipalCreationConditionSet, error) {
	req, err := r.NewJSONRequest(method, path, obj)
	if err != nil {
		return nil, err
	}
...
// GetN performs GET request for ServicePrincipalCreationConditionSet collection, max N pages
func (r *ServicePrincipalCreationPolicyIncludesCollectionRequest) GetN(ctx context.Context, n int) ([]ServicePrincipalCreationConditionSet, error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Get performs GET request for ServicePrincipalCreationConditionSet collection
func (r *ServicePrincipalCreationPolicyIncludesCollectionRequest) Get(ctx context.Context) ([]ServicePrincipalCreationConditionSet, error) {
	return r.GetN(ctx, 0)
}

// Add performs POST request for ServicePrincipalCreationConditionSet collection
func (r *ServicePrincipalCreationPolicyIncludesCollectionRequest) Add(ctx context.Context, reqObj *ServicePrincipalCreationConditionSet) (resObj *ServicePrincipalCreationConditionSet, err error) {
	err = r.JSONRequest(ctx, "POST", "", reqObj, &resObj)
	return
}
...
// Entity is navigation property rn
func (b *ServicePrincipalCreationConditionSetRequestBuilder) Entity() *EntityRequestBuilder {
	bb := &EntityRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/Entity"
	return bb
}
