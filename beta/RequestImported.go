...
// ImportedAppleDeviceIdentityResultRequestBuilder is request builder for ImportedAppleDeviceIdentityResult
type ImportedAppleDeviceIdentityResultRequestBuilder struct{ BaseRequestBuilder }

// Request returns ImportedAppleDeviceIdentityResultRequest
func (b *ImportedAppleDeviceIdentityResultRequestBuilder) Request() *ImportedAppleDeviceIdentityResultRequest {
	return &ImportedAppleDeviceIdentityResultRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ImportedAppleDeviceIdentityResultRequest is request for ImportedAppleDeviceIdentityResult
type ImportedAppleDeviceIdentityResultRequest struct{ BaseRequest }

// Get performs GET request for ImportedAppleDeviceIdentityResult
func (r *ImportedAppleDeviceIdentityResultRequest) Get(ctx context.Context) (resObj *ImportedAppleDeviceIdentityResult, err error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Update performs PATCH request for ImportedAppleDeviceIdentityResult
func (r *ImportedAppleDeviceIdentityResultRequest) Update(ctx context.Context, reqObj *ImportedAppleDeviceIdentityResult) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for ImportedAppleDeviceIdentityResult
func (r *ImportedAppleDeviceIdentityResultRequest) Delete(ctx context.Context) error {
	return r.JSONRequest(ctx, "DELETE", "", nil, nil)
}
...
// ImportedDeviceIdentityResultRequestBuilder is request builder for ImportedDeviceIdentityResult
type ImportedDeviceIdentityResultRequestBuilder struct{ BaseRequestBuilder }

// Request returns ImportedDeviceIdentityResultRequest
func (b *ImportedDeviceIdentityResultRequestBuilder) Request() *ImportedDeviceIdentityResultRequest {
	return &ImportedDeviceIdentityResultRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ImportedDeviceIdentityResultRequest is request for ImportedDeviceIdentityResult
type ImportedDeviceIdentityResultRequest struct{ BaseRequest }

// Get performs GET request for ImportedDeviceIdentityResult
func (r *ImportedDeviceIdentityResultRequest) Get(ctx context.Context) (resObj *ImportedDeviceIdentityResult, err error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
// Update performs PATCH request for ImportedDeviceIdentityResult
func (r *ImportedDeviceIdentityResultRequest) Update(ctx context.Context, reqObj *ImportedDeviceIdentityResult) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for ImportedDeviceIdentityResult
func (r *ImportedDeviceIdentityResultRequest) Delete(ctx context.Context) error {
	return r.JSONRequest(ctx, "DELETE", "", nil, nil)
}
...
// ImportAppleDeviceIdentityList action undocumentedrac
...
// ImportDeviceIdentityList action undocumentedrac
...
// SearchExistingIdentities action undocumentedrac
