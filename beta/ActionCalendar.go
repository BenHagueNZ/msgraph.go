...
// CalendarCalendarPermissionsCollectionRequestBuilder is request builder for CalendarPermission collection rcn
...
// CalendarCalendarViewCollectionRequestBuilder is request builder for Event collection rcn
...
// CalendarEventsCollectionRequestBuilder is request builder for Event collection rcn
...
// CalendarMultiValueExtendedPropertiesCollectionRequestBuilder is request builder for MultiValueLegacyExtendedProperty collection rcn
...
// CalendarSingleValueExtendedPropertiesCollectionRequestBuilder is request builder for SingleValueLegacyExtendedProperty collection rcn
...
// CalendarGroupCalendarsCollectionRequestBuilder is request builder for Calendar collection rcn
...
func (b *CalendarRequestBuilder) Entity() *EntityRequestBuilder {
...
// Entity is navigation property rn
func (b *CalendarGroupRequestBuilder) Entity() *EntityRequestBuilder {
	bb := &EntityRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/Entity"
	return bb
}
...
// Entity is navigation property rn
func (b *CalendarPermissionRequestBuilder) Entity() *EntityRequestBuilder {
	bb := &EntityRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/Entity"
	return bb
}
...
// MailFolderMessagesCollectionCalendarSharingMessageCollectionRequestBuilder is request builder for CalendarSharingMessage collection rcn
...
func (r *MailFolderMessagesCollectionCalendarSharingMessageCollectionRequest) Paging(ctx context.Context, method, path string, obj interface{}, n int) ([]CalendarSharingMessage, error) {
	...
	var values []CalendarSharingMessage
	for {
		if res.StatusCode != http.StatusOK {
			b, _ := ioutil.ReadAll(res.Body)
			res.Body.Close()
