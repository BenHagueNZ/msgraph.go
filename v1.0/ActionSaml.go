...
func (b *B2xIdentityUserFlowUserFlowIdentityProvidersCollectionRequestBuilder) SamlOrWsFedExternalDomainFederation() *B2xIdentityUserFlowUserFlowIdentityProvidersCollectionSamlOrWsFedExternalDomainFederationCollectionRequestBuilder {
	bb := &B2xIdentityUserFlowUserFlowIdentityProvidersCollectionSamlOrWsFedExternalDomainFederationCollectionRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/"
	return bb
}

// B2xIdentityUserFlowUserFlowIdentityProvidersCollectionSamlOrWsFedExternalDomainFederationCollectionRequestBuilder is request builder for SamlOrWsFedExternalDomainFederation collection rcn
type B2xIdentityUserFlowUserFlowIdentityProvidersCollectionSamlOrWsFedExternalDomainFederationCollectionRequestBuilder struct{ BaseRequestBuilder }

// Request returns request for SamlOrWsFedExternalDomainFederation collection
func (b *B2xIdentityUserFlowUserFlowIdentityProvidersCollectionSamlOrWsFedExternalDomainFederationCollectionRequestBuilder) Request() *B2xIdentityUserFlowUserFlowIdentityProvidersCollectionSamlOrWsFedExternalDomainFederationCollectionRequest {
	return &B2xIdentityUserFlowUserFlowIdentityProvidersCollectionSamlOrWsFedExternalDomainFederationCollectionRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// ID returns request builder for SamlOrWsFedExternalDomainFederation item
func (b *B2xIdentityUserFlowUserFlowIdentityProvidersCollectionSamlOrWsFedExternalDomainFederationCollectionRequestBuilder) ID(id string) *SamlOrWsFedExternalDomainFederationRequestBuilder {
	bb := &SamlOrWsFedExternalDomainFederationRequestBuilder{BaseRequestBuilder: b.BaseRequestBuilder}
	bb.baseURL += "/" + id
	return bb
}

// B2xIdentityUserFlowUserFlowIdentityProvidersCollectionSamlOrWsFedExternalDomainFederationCollectionRequest is request for SamlOrWsFedExternalDomainFederation collection
type B2xIdentityUserFlowUserFlowIdentityProvidersCollectionSamlOrWsFedExternalDomainFederationCollectionRequest struct{ BaseRequest }

// Paging perfoms paging operation for SamlOrWsFedExternalDomainFederation collection
func (r *B2xIdentityUserFlowUserFlowIdentityProvidersCollectionSamlOrWsFedExternalDomainFederationCollectionRequest) Paging(ctx context.Context, method, path string, obj interface{}, n int) ([]SamlOrWsFedExternalDomainFederation, error) {
	req, err := r.NewJSONRequest(method, path, obj)
	if err != nil {
		return nil, err
	}
...
func (r *B2xIdentityUserFlowUserFlowIdentityProvidersCollectionSamlOrWsFedExternalDomainFederationCollectionRequest) GetN(ctx context.Context, n int) ([]SamlOrWsFedExternalDomainFederation, error) {
	var query string
	if r.query != nil {
		query = "?" + r.query.Encode()
	}
...
func (r *B2xIdentityUserFlowUserFlowIdentityProvidersCollectionSamlOrWsFedExternalDomainFederationCollectionRequest) Get(ctx context.Context) ([]SamlOrWsFedExternalDomainFederation, error) {
	return r.GetN(ctx, 0)
}

// Add performs POST request for SamlOrWsFedExternalDomainFederation collection
func (r *B2xIdentityUserFlowUserFlowIdentityProvidersCollectionSamlOrWsFedExternalDomainFederationCollectionRequest) Add(ctx context.Context, reqObj *SamlOrWsFedExternalDomainFederation) (resObj *SamlOrWsFedExternalDomainFederation, err error) {
	err = r.JSONRequest(ctx, "POST", "", reqObj, &resObj)
	return
}
