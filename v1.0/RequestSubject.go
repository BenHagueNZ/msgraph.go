...
// SubjectRightsRequestRequestBuilder is request builder for SubjectRightsRequest
type SubjectRightsRequestRequestBuilder struct{ BaseRequestBuilder }

// Request returns SubjectRightsRequestRequest
func (b *SubjectRightsRequestRequestBuilder) Request() *SubjectRightsRequestRequest {
	return &SubjectRightsRequestRequest{
		BaseRequest: BaseRequest{baseURL: b.baseURL, client: b.client},
	}
}

// SubjectRightsRequestRequest is request for SubjectRightsRequest
type SubjectRightsRequestRequest struct{ BaseRequest }

// Get performs GET request for SubjectRightsRequest
func (r *SubjectRightsRequestRequest) Get(ctx context.Context) (resObj *SubjectRightsRequest, err error) {
	var query string
	if r.query != nil {
...
// Update performs PATCH request for SubjectRightsRequest
func (r *SubjectRightsRequestRequest) Update(ctx context.Context, reqObj *SubjectRightsRequest) error {
	return r.JSONRequest(ctx, "PATCH", "", reqObj, nil)
}

// Delete performs DELETE request for SubjectRightsRequest
func (r *SubjectRightsRequestRequest) Delete(ctx context.Context) error {
